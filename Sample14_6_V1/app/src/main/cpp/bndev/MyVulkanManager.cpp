...
ObjObject*  MyVulkanManager::objObjectVER;
...
void MyVulkanManager::createDrawableObject(){					
    objObjectVER	 = LoadUtil::loadFromFile("model/ver.obj", device, memoryroperties);
...
void MyVulkanManager::initMatrixAndLight()
{
    ...
    LightManager::setLightPosition(50,40,30);
    LightManager::setlightAmbient(0.3f,0.3f,0.3f,0.3f);
...
void MyVulkanManager::drawObject()
{
    ...
    while(MyVulkanManager::loopDrawFlag)
    {
        ...
        objObjectVER->drawSelf(cmdBuffer, sqsCT->pipelineLayout, sqsCT->pipeline,
                               &(sqsCT->descSet[0]),1);
        MatrixState3D::popMatrix();
        MatrixState3D::pushMatrix();
        MatrixState3D::scale(2.0f, 2.0f, 2.0f);
