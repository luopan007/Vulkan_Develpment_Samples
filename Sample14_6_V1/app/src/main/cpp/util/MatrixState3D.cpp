...
float MatrixState3D::mMPCMatrix[16];
float MatrixState3D::mMVPMatrix[16];
float MatrixState3D::mStack[10][16];
int MatrixState3D::stackTop=-1;
float MatrixState3D::CX=0;
float MatrixState3D::CY=0;
float MatrixState3D::CZ=0;
...
float* MatrixState3D::getViewProjMatrix()
{
	Matrix::multiplyMM(mMPCMatrix, 0, mProjMatrix, 0, mVMatrix, 0);
	Matrix::multiplyMM(mMPCMatrix, 0, vulkanClipMatrix, 0, mMPCMatrix, 0);
	return mMPCMatrix;
}
