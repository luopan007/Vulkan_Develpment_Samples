...
std::vector<std::string> TextureManager::texNames={"texture/default_c.bntex","texture/default_d.bntex","texture/detailTexture_1.bntex","texture/detailTexture_2.bntex","texture/detailTexture_3.bntex","texture/detailTexture_4.bntex"};
