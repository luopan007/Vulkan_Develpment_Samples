...
class MyVulkanManager
{
  public:
    ...
    static ShaderQueueSuit_CommonTexParticle* sqsParticle;
    static ShaderQueueSuit_CommonTexParticleTwo* sqsParticleTwo;
    static ShaderQueueSuit_CommonTexParticleThree* sqsParticleThree;
    static ShaderQueueSuit_CommonTexParticleFour* sqsParticleFour;
    static ObjObject* LYobjB;
    static ObjObject* LYobjDiban;//地板
    static ParticleForDraw* LYobjParticle[4];//粒子系统
    static  std::vector<ParticleSystem*> particleVector;
    static std::mutex myLock;//资源锁
    static bool compare(ParticleSystem *pa,ParticleSystem *another);
    ...
    static void updateParticleSystem();
};
#endif 
