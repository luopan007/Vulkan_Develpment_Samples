#ifndef VULKANEXBASE_ShaderQueueSuit_CommonTexParticle_H
#define VULKANEXBASE_ShaderQueueSuit_CommonTexParticle_H
#include <vector>
#include <vulkan/vulkan.h>
#include "../vksysutil/vulkan_wrapper.h"
class ShaderQueueSuit_CommonTexParticle
{
private:
    VkBuffer uniformBuf;
  ...
  public:
    ...
    VkPipeline pipeline;
    ShaderQueueSuit_CommonTexParticle(VkDevice* deviceIn,VkRenderPass& renderPass,VkPhysicalDeviceMemoryProperties& memoryroperties);
    ~ShaderQueueSuit_CommonTexParticle();
};
#endif
