#ifndef VULKANEXBASE_ShaderQueueSuit_CommonTexParticleThree_H
#define VULKANEXBASE_ShaderQueueSuit_CommonTexParticleThree_H
#include <vector>
#include <vulkan/vulkan.h>
#include "../vksysutil/vulkan_wrapper.h"
class ShaderQueueSuit_CommonTexParticleThree
{
private:
    VkBuffer uniformBuf;
...
public:
    ...
    VkPipeline pipeline;
    ShaderQueueSuit_CommonTexParticleThree(VkDevice* deviceIn,VkRenderPass& renderPass,VkPhysicalDeviceMemoryProperties& memoryroperties);
    ~ShaderQueueSuit_CommonTexParticleThree();
};
#endif
