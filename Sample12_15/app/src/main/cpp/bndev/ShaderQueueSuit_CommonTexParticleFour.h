#ifndef VULKANEXBASE_ShaderQueueSuit_CommonTexParticleFour_H
#define VULKANEXBASE_ShaderQueueSuit_CommonTexParticleFour_H
#include <vector>
#include <vulkan/vulkan.h>
#include "../vksysutil/vulkan_wrapper.h"
class ShaderQueueSuit_CommonTexParticleFour
{
private:
    VkBuffer uniformBuf;
...
public:
    ...
    VkPipeline pipeline;
    ShaderQueueSuit_CommonTexParticleFour(VkDevice* deviceIn,VkRenderPass& renderPass,VkPhysicalDeviceMemoryProperties& memoryroperties);
    ~ShaderQueueSuit_CommonTexParticleFour();
};
#endif
