...
void MyVulkanManager::initMatrix()
{
    ...
    LightManager::setLightPosition(60,80,60);
    LightManager::setlightAmbient(0.15f, 0.15f, 0.15f, 0.15f);
    LightManager::setlightDiffuse(0.9f, 0.9f, 0.9f, 0.9f);
...
void MyVulkanManager::flushTexToDesSet()
{
    for(int i=0;i<TextureManager::texNames.size();i++)
    {
        ...
        sqsCL->writes[2].dstSet = sqsCL->descSet[i];
...
void MyVulkanManager::drawObject()
{
    ...
    while(MyVulkanManager::loopDrawFlag){
        ...
        objObjectPM->drawSelf(cmdBuffer, sqsCL->pipelineLayout, sqsCL->pipeline,
                              &(sqsCL->descSet[TextureManager::getVkDescriptorSetIndex("texture/tytt.bntex")]));
        MatrixState3D::pushMatrix();
        MatrixState3D::translate(0,0,30);
        MatrixState3D::scale(2.0f, 2.0f, 2.0f);
        objObjectCH->drawSelf(cmdBuffer, sqsCL->pipelineLayout, sqsCL->pipeline,
                              &(sqsCL->descSet[TextureManager::getVkDescriptorSetIndex("texture/tytt.bntex")]));
        MatrixState3D::popMatrix();
        MatrixState3D::pushMatrix();
        MatrixState3D::translate(-30, 0, 0);
        MatrixState3D::scale(2.0f, 2.0f, 2.0f);
        objObjectQT->drawSelf(cmdBuffer, sqsCL->pipelineLayout, sqsCL->pipeline,
                              &(sqsCL->descSet[TextureManager::getVkDescriptorSetIndex("texture/tytt.bntex")]));
        MatrixState3D::popMatrix();
        MatrixState3D::pushMatrix();
        MatrixState3D::translate(30, 0, 0);
        ...
        objObjectYH->drawSelf(cmdBuffer, sqsCL->pipelineLayout, sqsCL->pipeline,
                              &(sqsCL->descSet[TextureManager::getVkDescriptorSetIndex("texture/tytt.bntex")]));
        MatrixState3D::popMatrix();
        MatrixState3D::pushMatrix();
        MatrixState3D::translate(0, 0, -30);
        MatrixState3D::scale(2.0f, 2.0f, 2.0f);
        objObjectCFT->drawSelf(cmdBuffer, sqsCL->pipelineLayout, sqsCL->pipeline,
                               &(sqsCL->descSet[TextureManager::getVkDescriptorSetIndex("texture/tytt.bntex")]));
        MatrixState3D::popMatrix();
