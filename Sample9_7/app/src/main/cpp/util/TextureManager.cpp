...
std::vector<std::string> TextureManager::texNames={"texture/skycubemap_front.bntex",
        "texture/skycubemap_back.bntex","texture/skycubemap_left.bntex",
        "texture/skycubemap_right.bntex","texture/skycubemap_up.bntex",
