#ifndef SAMPLE12_3_SHADERQUEUESUIT_COMMONTEXIMAGE_H
#define SAMPLE12_3_SHADERQUEUESUIT_COMMONTEXIMAGE_H
#include <vector>
#include <vulkan/vulkan.h>
#include "../vksysutil/vulkan_wrapper.h"
class ShaderQueueSuit_CommonTexImage {
private:
    VkBuffer uniformBuf;
...
public:
    ...
    VkPipeline pipeline;
    ShaderQueueSuit_CommonTexImage(VkDevice* deviceIn,VkRenderPass& renderPass,VkPhysicalDeviceMemoryProperties& memoryroperties);
    ~ShaderQueueSuit_CommonTexImage();
};
#endif //SAMPLE12_3_SHADERQUEUESUIT_COMMONTEXIMAGE_H
