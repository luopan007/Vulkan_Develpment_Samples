...
void MyVulkanManager::initMatrix(){ //初始化矩阵
    ...
    if(ProjectPara){NEAR=400.0f;} //较大的NEAR 值
    else{NEAR=1.0f;} //较小的NEAR 值
    MatrixState3D::setProjectFrustum(-NEAR*ratio*0.25f,NEAR*ratio*0.25f, //设置透视投影参数
                                     -NEAR*0.25f,NEAR*0.25f,NEAR,10000.0f);
}
