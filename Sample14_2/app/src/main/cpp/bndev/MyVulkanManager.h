...
class MyVulkanManager
{
  public:
    ...
    static ShaderQueueSuit_Common* sqsCT;
    static float* MProjCameraMatrix;
    static ObjObject* objObjectCH;
    static ObjObject* objObjectCFT;
    static ObjObject* objObjectQT;
    static ObjObject* objObjectYH;
    static ObjObject* objObjectPM;
    static float lightElevation;
    static int lightAzimuth;
    ...
    static void drawThings(float isShadow);
