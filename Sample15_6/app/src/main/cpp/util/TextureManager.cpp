...
std::vector<std::string> TextureManager::texNames={"texture/airship.bntex","texture/base.bntex","texture/airshipBloom.bntex","texture/baseBloom.bntex"};
std::vector<std::string> TextureManager::texNamesForCommonTexLight={"texture/airship.bntex","texture/base.bntex","texture/airshipBloom.bntex","texture/baseBloom.bntex"};
