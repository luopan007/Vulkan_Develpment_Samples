...
class MyVulkanManager
{
  public:
    ...
    static TexDrawableObject* texRect;
    static float rectX;
    static float rectY;
    static int rectState;
    static float moveSpan;
    ...
    static int left;
    static int right;
    static ShaderQueueSuit_Common* sqsCTL;
    static ObjObject* CHForDraw;
    static ObjObject* CFTForDraw;
    static ObjObject* QTForDraw;
    static ObjObject* YHForDraw;
    static ObjObject* PMForDraw;
