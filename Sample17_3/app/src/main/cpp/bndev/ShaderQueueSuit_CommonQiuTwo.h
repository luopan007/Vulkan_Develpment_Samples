#ifndef ShaderQueueSuit_CommonQiuTwo_H
#define ShaderQueueSuit_CommonQiuTwo_H
#include <vector>
#include <vulkan/vulkan.h>
#include "../vksysutil/vulkan_wrapper.h"
class ShaderQueueSuit_CommonQiuTwo
{
private:
    VkBuffer uniformBuf;
...
public:
    ...
    VkPipeline pipeline;
    ShaderQueueSuit_CommonQiuTwo(VkDevice* deviceIn,VkRenderPass& renderPass,VkPhysicalDeviceMemoryProperties& memoryroperties);
    ~ShaderQueueSuit_CommonQiuTwo();
};
#endif
