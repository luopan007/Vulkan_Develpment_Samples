#include "ShaderQueueSuit_CommonQiuTwo.h"
#include <assert.h>
...
#include <regex>
void ShaderQueueSuit_CommonQiuTwo::create_uniform_buffer(VkDevice& device,VkPhysicalDeviceMemoryProperties& memoryroperties)
{
...
void ShaderQueueSuit_CommonQiuTwo::destroy_uniform_buffer(VkDevice& device)
{
    vk::vkDestroyBuffer(device, uniformBuf, NULL);
    vk::vkFreeMemory(device, memUniformBuf, NULL);
}
void ShaderQueueSuit_CommonQiuTwo::create_pipeline_layout(VkDevice& device)
{
...
void ShaderQueueSuit_CommonQiuTwo::destroy_pipeline_layout(VkDevice& device)
{
...
void ShaderQueueSuit_CommonQiuTwo::init_descriptor_set(VkDevice& device)
{
...
void ShaderQueueSuit_CommonQiuTwo::create_shader(VkDevice& device)
{
...
void ShaderQueueSuit_CommonQiuTwo::destroy_shader(VkDevice& device)
{
    vk::vkDestroyShaderModule(device, shaderStages[0].module, NULL);
    vk::vkDestroyShaderModule(device, shaderStages[1].module, NULL);
}
void ShaderQueueSuit_CommonQiuTwo::initVertexAttributeInfo()
{
...
void ShaderQueueSuit_CommonQiuTwo::create_pipe_line(VkDevice& device,VkRenderPass& renderPass)
{
...
void ShaderQueueSuit_CommonQiuTwo::destroy_pipe_line(VkDevice& device)
{
    vk::vkDestroyPipeline(device, pipeline, NULL);
    vk::vkDestroyPipelineCache(device, pipelineCache, NULL);
}
ShaderQueueSuit_CommonQiuTwo::ShaderQueueSuit_CommonQiuTwo(VkDevice* deviceIn,VkRenderPass& renderPass,VkPhysicalDeviceMemoryProperties& memoryroperties)
{
...
ShaderQueueSuit_CommonQiuTwo::~ShaderQueueSuit_CommonQiuTwo()
{
