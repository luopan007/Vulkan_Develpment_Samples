...
public:
    ...
    static ShaderQueueSuit_CommonQiu* sqsQiu;
    static ShaderQueueSuit_CommonQiuTwo* sqsQiuTwo;
    static ShaderQueueSuit_CommonQiuThree* sqsQiuThree;
    static ObjObjectQiu* objQiu;
    static ObjObjectQiu* objQiuTwo;
    static ObjObjectQiu* objQiuThree;
    static ObjObject* objObject;
    static vector<Planet*> planetVector;
    static float xAngle;
    static float yAngle;
