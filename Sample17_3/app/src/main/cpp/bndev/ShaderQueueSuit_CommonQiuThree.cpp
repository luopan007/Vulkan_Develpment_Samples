#include "ShaderQueueSuit_CommonQiuThree.h"
#include <assert.h>
...
#include <regex>
void ShaderQueueSuit_CommonQiuThree::create_uniform_buffer(VkDevice& device,VkPhysicalDeviceMemoryProperties& memoryroperties)
{
...
void ShaderQueueSuit_CommonQiuThree::destroy_uniform_buffer(VkDevice& device)
{
    vk::vkDestroyBuffer(device, uniformBuf, NULL);
    vk::vkFreeMemory(device, memUniformBuf, NULL);
}
void ShaderQueueSuit_CommonQiuThree::create_pipeline_layout(VkDevice& device)
{
...
void ShaderQueueSuit_CommonQiuThree::destroy_pipeline_layout(VkDevice& device)
{
...
void ShaderQueueSuit_CommonQiuThree::init_descriptor_set(VkDevice& device)
{
...
void ShaderQueueSuit_CommonQiuThree::create_shader(VkDevice& device)
{
...
void ShaderQueueSuit_CommonQiuThree::destroy_shader(VkDevice& device)
{
    vk::vkDestroyShaderModule(device, shaderStages[0].module, NULL);
    vk::vkDestroyShaderModule(device, shaderStages[1].module, NULL);
}
void ShaderQueueSuit_CommonQiuThree::initVertexAttributeInfo()
{
...
void ShaderQueueSuit_CommonQiuThree::create_pipe_line(VkDevice& device,VkRenderPass& renderPass)
{
...
void ShaderQueueSuit_CommonQiuThree::destroy_pipe_line(VkDevice& device)
{
    vk::vkDestroyPipeline(device, pipeline, NULL);
    vk::vkDestroyPipelineCache(device, pipelineCache, NULL);
}
ShaderQueueSuit_CommonQiuThree::ShaderQueueSuit_CommonQiuThree(VkDevice* deviceIn,VkRenderPass& renderPass,VkPhysicalDeviceMemoryProperties& memoryroperties)
{
...
ShaderQueueSuit_CommonQiuThree::~ShaderQueueSuit_CommonQiuThree()
{
