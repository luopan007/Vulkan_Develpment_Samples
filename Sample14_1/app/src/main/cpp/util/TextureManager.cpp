...
std::vector<std::string> TextureManager::texNames={"texture/ghxp.bntex","texture/car.bntex","texture/tree.bntex"};
std::vector<std::string> TextureManager::texNamesForCommonTexLight={"texture/ghxp.bntex","texture/car.bntex","texture/tree.bntex"};
