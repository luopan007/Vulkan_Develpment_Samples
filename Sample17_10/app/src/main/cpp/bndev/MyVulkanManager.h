...
class MyVulkanManager
{
  public:
   ...
   #define SELF_COLOR_COUNT 3
    static VkImage colorImage[SELF_COLOR_COUNT];
    static VkDeviceMemory memColor[SELF_COLOR_COUNT];
    static VkImageView colorImageView[SELF_COLOR_COUNT];
    static VkDescriptorImageInfo colorImageInfo[SELF_COLOR_COUNT];
    static VkSemaphore imageAcquiredSemaphore;
    static uint32_t currentBuffer;
    static VkRenderPass renderPass;
    static VkClearValue clear_values[5];
    ...
    static ShaderQueueSuit_PreProcess* sqsCTL;
    static ShaderQueueSuit_Light* sqsL;
    static ObjObject* CHForDraw;
    static ObjObject* carForDraw;
    static ObjObject* treeForDraw;
    static ObjObject* floorForDraw;
