#ifndef VULKANEXBASE_SHADERQUEUESUIT_Discard_H
#define VULKANEXBASE_SHADERQUEUESUIT_Discard_H
#include <vector>
...
public:
    ...
    VkPipeline pipeline;
    ShaderQueueSuit_Discard(VkDevice* deviceIn,VkRenderPass& renderPass,VkPhysicalDeviceMemoryProperties& memoryroperties);
