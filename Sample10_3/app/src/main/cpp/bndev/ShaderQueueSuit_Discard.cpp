...
#include "ShaderQueueSuit_Discard.h"
void ShaderQueueSuit_Discard::create_uniform_buffer(VkDevice& device,VkPhysicalDeviceMemoryProperties& memoryroperties)
{
...
void ShaderQueueSuit_Discard::destroy_uniform_buffer(VkDevice& device)
{
    vk::vkDestroyBuffer(device, uniformBuf, NULL);
    vk::vkFreeMemory(device, memUniformBuf, NULL);
}
void ShaderQueueSuit_Discard::create_pipeline_layout(VkDevice& device)
{
...
void ShaderQueueSuit_Discard::destroy_pipeline_layout(VkDevice& device)
{
...
void ShaderQueueSuit_Discard::init_descriptor_set(VkDevice& device)
{
...
void ShaderQueueSuit_Discard::create_shader(VkDevice& device)
{
    std::string vertStr= FileUtil::loadAssetStr("shader/commonTexLight.vert");
    std::string fragStr= FileUtil::loadAssetStr("shader/discardTexLight.frag");
...
void ShaderQueueSuit_Discard::create_pipe_line(VkDevice& device,VkRenderPass& renderPass)
{
...
void ShaderQueueSuit_Discard::destroy_pipe_line(VkDevice& device)
{
    vk::vkDestroyPipeline(device, pipeline, NULL);
    vk::vkDestroyPipelineCache(device, pipelineCache, NULL);
}
ShaderQueueSuit_Discard::ShaderQueueSuit_Discard(VkDevice* deviceIn,VkRenderPass& renderPass,VkPhysicalDeviceMemoryProperties& memoryroperties)
{
...
ShaderQueueSuit_Discard::~ShaderQueueSuit_Discard()
{
