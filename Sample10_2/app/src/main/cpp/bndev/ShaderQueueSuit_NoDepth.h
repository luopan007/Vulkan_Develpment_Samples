#ifndef VULKANEXBASE_SHADERQUEUESUIT_NoDepth_H
#define VULKANEXBASE_SHADERQUEUESUIT_NoDepth_H
#include <vector>
#include <vulkan/vulkan.h>
#include "../vksysutil/vulkan_wrapper.h"
class ShaderQueueSuit_NoDepth
{
private:
    VkBuffer uniformBuf;
...
public:
    ...
    VkPipeline pipeline;
    ShaderQueueSuit_NoDepth(VkDevice* deviceIn,VkRenderPass& renderPass,VkPhysicalDeviceMemoryProperties& memoryroperties);
    ~ShaderQueueSuit_NoDepth();
};
#endif
