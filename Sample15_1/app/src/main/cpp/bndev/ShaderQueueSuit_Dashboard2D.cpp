...
void ShaderQueueSuit_Dashboard2D::create_pipeline_layout(VkDevice& device)
{
    ...
    descriptor_layout.bindingCount = 6;
...
{
    VkDescriptorPoolSize type_count[7];
    ...
    type_count[5].descriptorCount = 1;
    type_count[6].type = VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER;
    type_count[6].descriptorCount = 1;
    VkDescriptorPoolCreateInfo descriptor_pool = {};
    descriptor_pool.sType = VK_STRUCTURE_TYPE_DESCRIPTOR_POOL_CREATE_INFO;
    descriptor_pool.pNext = NULL;
    descriptor_pool.maxSets = 1;
    descriptor_pool.poolSizeCount = 7;
...
{
    std::string vertStr= FileUtil::loadAssetStr("shader/common2D.vert");
    std::string fragStr= FileUtil::loadAssetStr("shader/common2D.frag");
