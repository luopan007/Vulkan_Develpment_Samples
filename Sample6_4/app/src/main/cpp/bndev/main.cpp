			...
			if(AInputEvent_getSource(event)==AINPUT_SOURCE_TOUCHSCREEN)
			{
				...
				switch(id)
				{
					...
					case AMOTION_EVENT_ACTION_UP:
						if(isClick){ //点击标志为true
							switch(pressType){//根据不同的pressType值分支
								case 0:MyVulkanManager::smallType=0;MyVulkanManager::bigType=1;//第1种组合
									break;
								case 1:MyVulkanManager::smallType=1;MyVulkanManager::bigType=0; //第2种组合
									break;
								case 2:MyVulkanManager::smallType=0;MyVulkanManager::bigType=0; //第3种组合
									break;
								case 3:MyVulkanManager::smallType=1;MyVulkanManager::bigType=1; //第4种组合
									break;
