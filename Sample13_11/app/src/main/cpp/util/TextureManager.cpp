...
std::vector<std::string> TextureManager::texNames = {   "texture/house.bntex","texture/qiao.bntex" ,"texture/stuff02.bntex" ,"texture/tree.bntex","texture/stuff01.bntex",
                                                        "texture/vegetation01.bntex" ,"texture/water.bntex","texture/sky.bntex" ,"texture/resultnt.bntex" };
std::vector<std::string> TextureManager::texNamesForObj = {	"texture/house.bntex" , "texture/qiao.bntex" , "texture/stuff02.bntex", "texture/tree.bntex","texture/stuff01.bntex",
                                                               "texture/vegetation01.bntex" ,"texture/water.bntex","texture/sky.bntex" };
std::vector<std::string> TextureManager::texNamesForWater = { "texture/water.bntex" , "texture/resultnt.bntex" };
...
{
    VkSamplerCreateInfo samplerCreateInfo[SAMPLER_COUNT] = {};
    samplerCreateInfo[0].sType = VK_STRUCTURE_TYPE_SAMPLER_CREATE_INFO;
    samplerCreateInfo[0].magFilter = VK_FILTER_LINEAR;
    samplerCreateInfo[0].minFilter = VK_FILTER_NEAREST;
    samplerCreateInfo[0].mipmapMode = VK_SAMPLER_MIPMAP_MODE_NEAREST;
    samplerCreateInfo[0].addressModeU = VK_SAMPLER_ADDRESS_MODE_REPEAT;
    samplerCreateInfo[0].addressModeV = VK_SAMPLER_ADDRESS_MODE_REPEAT;
    samplerCreateInfo[0].addressModeW = VK_SAMPLER_ADDRESS_MODE_REPEAT;
    samplerCreateInfo[0].mipLodBias = 0.0;
    samplerCreateInfo[0].anisotropyEnable = VK_FALSE;
    samplerCreateInfo[0].maxAnisotropy = 1;
    samplerCreateInfo[0].compareOp = VK_COMPARE_OP_NEVER;
    samplerCreateInfo[0].minLod = 0.0;
    samplerCreateInfo[0].maxLod = 0.0;
    samplerCreateInfo[0].compareEnable = VK_FALSE;
    samplerCreateInfo[0].borderColor = VK_BORDER_COLOR_FLOAT_OPAQUE_WHITE;
    samplerCreateInfo[1].sType = VK_STRUCTURE_TYPE_SAMPLER_CREATE_INFO;
    samplerCreateInfo[1].magFilter = VK_FILTER_LINEAR;
    samplerCreateInfo[1].minFilter = VK_FILTER_LINEAR;
    samplerCreateInfo[1].mipmapMode = VK_SAMPLER_MIPMAP_MODE_NEAREST;
    samplerCreateInfo[1].addressModeU = VK_SAMPLER_ADDRESS_MODE_CLAMP_TO_EDGE;
    samplerCreateInfo[1].addressModeV = VK_SAMPLER_ADDRESS_MODE_CLAMP_TO_EDGE;
    samplerCreateInfo[1].addressModeW = VK_SAMPLER_ADDRESS_MODE_CLAMP_TO_EDGE;
    samplerCreateInfo[1].mipLodBias = 0.0;
    samplerCreateInfo[1].anisotropyEnable = VK_FALSE;
    samplerCreateInfo[1].maxAnisotropy = 1;
    samplerCreateInfo[1].compareOp = VK_COMPARE_OP_NEVER;
    samplerCreateInfo[1].minLod = 0.0;
    samplerCreateInfo[1].maxLod = 0.0;
    samplerCreateInfo[1].compareEnable = VK_FALSE;
    samplerCreateInfo[1].borderColor = VK_BORDER_COLOR_FLOAT_OPAQUE_WHITE;
    for (int i = 0; i<SAMPLER_COUNT; i++)
    {
        VkSampler samplerTexture;
        VkResult result = vk::vkCreateSampler(device, &samplerCreateInfo[i], NULL, &samplerTexture);
