...
float MatrixState3D::mMirrorMVPMatrix[16];
...
{
    Matrix::multiplyMM(mMirrorMVPMatrix, 0, mProjMatrix, 0, mVMatrix, 0);
    Matrix::multiplyMM(mMirrorMVPMatrix, 0, vulkanClipMatrix, 0, mMirrorMVPMatrix, 0);
	return mMirrorMVPMatrix;
}
