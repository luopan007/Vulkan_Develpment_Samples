...
public:
    ...
    static std::vector<std::string> texNameSingle;
...
private:
    ...
    static void init_SPEC_2D_Textures(std::string texName, VkDevice& device, VkPhysicalDevice& gpu, VkPhysicalDeviceMemoryProperties& memoryroperties, VkCommandBuffer& cmdBuffer, VkQueue& queueGraphics,VkFormat format, CommonTexDataObject* ctdo);
};
#endif 
