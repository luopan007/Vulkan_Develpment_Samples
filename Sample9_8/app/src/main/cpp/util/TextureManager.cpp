...
std::vector<std::string> TextureManager::texNames={"texture/grassMipMap.bntex","texture/rock.bntex","texture/sky.bntex"};
std::vector<std::string> TextureManager::texNameSingle = {"texture/sky.bntex"};
...
void TextureManager::init_SPEC_2D_Textures(std::string texName, VkDevice& device, VkPhysicalDevice& gpu, VkPhysicalDeviceMemoryProperties& memoryroperties, VkCommandBuffer& cmdBuffer, VkQueue& queueGraphics,VkFormat format, CommonTexDataObject* ctdo)
{
