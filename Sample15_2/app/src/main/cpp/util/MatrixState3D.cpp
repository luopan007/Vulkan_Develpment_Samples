...
float MatrixState3D::mMPCMatrixPrevious[16];
float MatrixState3D::mMPCMatrixCurrent[16];
...
float* MatrixState3D::getViewProjMatrixPrevious()
{
	Matrix::multiplyMM(mMPCMatrixPrevious, 0, mProjMatrix, 0, mVMatrix, 0);
	Matrix::multiplyMM(mMPCMatrixPrevious, 0, vulkanClipMatrix, 0, mMPCMatrixPrevious, 0);
	return mMPCMatrixPrevious;
}
float* MatrixState3D::getViewProjMatrixCurrent()
{
    Matrix::multiplyMM(mMPCMatrixCurrent, 0, mProjMatrix, 0, mVMatrix, 0);
    Matrix::multiplyMM(mMPCMatrixCurrent, 0, vulkanClipMatrix, 0, mMPCMatrixCurrent, 0);
    return mMPCMatrixCurrent;
}
