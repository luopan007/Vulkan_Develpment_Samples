...
{
    bufferByteCount=sizeof(float)*33;
...
void ShaderQueueSuit_Dashboard2D::init_descriptor_set(VkDevice& device)
{
    ...
    type_count[0].descriptorCount = OUT_TEX_COUNT;
    type_count[1].type = VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER;
    type_count[1].descriptorCount = OUT_TEX_COUNT;
    type_count[2].type = VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER;
    type_count[2].descriptorCount = OUT_TEX_COUNT;
    VkDescriptorPoolCreateInfo descriptor_pool = {};
    descriptor_pool.sType = VK_STRUCTURE_TYPE_DESCRIPTOR_POOL_CREATE_INFO;
    descriptor_pool.pNext = NULL;
    descriptor_pool.maxSets = OUT_TEX_COUNT;
    ...
    alloc_info[0].descriptorSetCount =OUT_TEX_COUNT;
    alloc_info[0].pSetLayouts = layouts.data();
    descSet.resize(OUT_TEX_COUNT);
