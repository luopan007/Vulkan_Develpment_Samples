...
void ShaderQueueSuit_CommonTex::create_pipeline_layout(VkDevice& device)
{
...
void ShaderQueueSuit_CommonTex::init_descriptor_set(VkDevice& device)
{
    VkDescriptorPoolSize type_count[2];
    type_count[0].type = VK_DESCRIPTOR_TYPE_UNIFORM_BUFFER;
    type_count[0].descriptorCount = TextureManager::texNamesForSky.size();
    type_count[1].type = VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER;
    type_count[1].descriptorCount = TextureManager::texNamesForSky.size();
    VkDescriptorPoolCreateInfo descriptor_pool = {};
    descriptor_pool.sType = VK_STRUCTURE_TYPE_DESCRIPTOR_POOL_CREATE_INFO;
    descriptor_pool.pNext = NULL;
    descriptor_pool.maxSets = TextureManager::texNamesForSky.size();
    ...
    alloc_info[0].descriptorSetCount =TextureManager::texNamesForSky.size();
    alloc_info[0].pSetLayouts = layouts.data();
    descSet.resize(TextureManager::texNamesForSky.size());
...
void ShaderQueueSuit_CommonTex::initVertexAttributeInfo()
{
