...
class MyVulkanManager
{
  public:
    ...
    static Dashboard2DObject* sky;
    static Dashboard2DObject* landForDraw;
    static ObjObject* tree1;
    static ObjObject* tree2;
    static Dashboard2DObject* d2dA;
    static float SPAN;
    static float cz;
    static float targetz;
    static float preCZ;
    static float preTargetZ;
    static float* mViewProjectionInverseMatrix;
    static float* mPreviousProjectionMatrix;
    ...
    static void drawTrees(int treeIndex,float transX,float transY,float transZ);
