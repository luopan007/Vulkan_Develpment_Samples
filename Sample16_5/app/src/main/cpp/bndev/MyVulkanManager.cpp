...
void MyVulkanManager::updateBNGGDH()
{
...
{
    thread t1(&MyVulkanManager::updateBNGGDH);
    t1.detach();
    FPSUtil::init();
    while (MyVulkanManager::loopDrawFlag)
    {
        ...
        MatrixState3D::rotate(150,0,1,0);
        bnModelA->draw(cmdBuffer, sqsCL->pipelineLayout, sqsCL->pipeline);
