#include "ShaderQueueSuit_CommonTexParticleTwo.h"
#include <assert.h>
...
void ShaderQueueSuit_CommonTexParticleTwo::create_uniform_buffer(VkDevice& device,VkPhysicalDeviceMemoryProperties& memoryroperties)
{
...
void ShaderQueueSuit_CommonTexParticleTwo::destroy_uniform_buffer(VkDevice& device)
{
    vk::vkDestroyBuffer(device, uniformBuf, NULL);
    vk::vkFreeMemory(device, memUniformBuf, NULL);
}
void ShaderQueueSuit_CommonTexParticleTwo::create_pipeline_layout(VkDevice& device)
{
...
void ShaderQueueSuit_CommonTexParticleTwo::destroy_pipeline_layout(VkDevice& device)
{
...
void ShaderQueueSuit_CommonTexParticleTwo::init_descriptor_set(VkDevice& device)
{
...
void ShaderQueueSuit_CommonTexParticleTwo::create_shader(VkDevice& device)
{
...
void ShaderQueueSuit_CommonTexParticleTwo::destroy_shader(VkDevice& device)
{
    vk::vkDestroyShaderModule(device, shaderStages[0].module, NULL);
    vk::vkDestroyShaderModule(device, shaderStages[1].module, NULL);
}
void ShaderQueueSuit_CommonTexParticleTwo::initVertexAttributeInfo()
{
...
void ShaderQueueSuit_CommonTexParticleTwo::create_pipe_line(VkDevice& device,VkRenderPass& renderPass)
{
...
void ShaderQueueSuit_CommonTexParticleTwo::destroy_pipe_line(VkDevice& device)
{
    vk::vkDestroyPipeline(device, pipeline, NULL);
    vk::vkDestroyPipelineCache(device, pipelineCache, NULL);
}
ShaderQueueSuit_CommonTexParticleTwo::ShaderQueueSuit_CommonTexParticleTwo(VkDevice* deviceIn,VkRenderPass& renderPass,VkPhysicalDeviceMemoryProperties& memoryroperties)
{
...
ShaderQueueSuit_CommonTexParticleTwo::~ShaderQueueSuit_CommonTexParticleTwo()
{
