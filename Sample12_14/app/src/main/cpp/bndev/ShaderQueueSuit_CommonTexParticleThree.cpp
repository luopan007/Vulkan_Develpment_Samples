#include "ShaderQueueSuit_CommonTexParticleThree.h"
#include <assert.h>
...
void ShaderQueueSuit_CommonTexParticleThree::create_uniform_buffer(VkDevice& device,VkPhysicalDeviceMemoryProperties& memoryroperties)
{
...
void ShaderQueueSuit_CommonTexParticleThree::destroy_uniform_buffer(VkDevice& device)
{
    vk::vkDestroyBuffer(device, uniformBuf, NULL);
    vk::vkFreeMemory(device, memUniformBuf, NULL);
}
void ShaderQueueSuit_CommonTexParticleThree::create_pipeline_layout(VkDevice& device)
{
...
void ShaderQueueSuit_CommonTexParticleThree::destroy_pipeline_layout(VkDevice& device)
{
...
void ShaderQueueSuit_CommonTexParticleThree::init_descriptor_set(VkDevice& device)
{
...
void ShaderQueueSuit_CommonTexParticleThree::create_shader(VkDevice& device)
{
...
void ShaderQueueSuit_CommonTexParticleThree::destroy_shader(VkDevice& device)
{
    vk::vkDestroyShaderModule(device, shaderStages[0].module, NULL);
    vk::vkDestroyShaderModule(device, shaderStages[1].module, NULL);
}
void ShaderQueueSuit_CommonTexParticleThree::initVertexAttributeInfo()
{
...
void ShaderQueueSuit_CommonTexParticleThree::create_pipe_line(VkDevice& device,VkRenderPass& renderPass)
{
    ...
    att_state[0].srcAlphaBlendFactor = VK_BLEND_FACTOR_SRC_ALPHA;//设置源Alpha 混合因子
    att_state[0].dstAlphaBlendFactor = VK_BLEND_FACTOR_ONE_MINUS_SRC_ALPHA;//设置目标Alpha 混合因子
...
void ShaderQueueSuit_CommonTexParticleThree::destroy_pipe_line(VkDevice& device)
{
    vk::vkDestroyPipeline(device, pipeline, NULL);
    vk::vkDestroyPipelineCache(device, pipelineCache, NULL);
}
ShaderQueueSuit_CommonTexParticleThree::ShaderQueueSuit_CommonTexParticleThree(VkDevice* deviceIn,VkRenderPass& renderPass,VkPhysicalDeviceMemoryProperties& memoryroperties)
{
...
ShaderQueueSuit_CommonTexParticleThree::~ShaderQueueSuit_CommonTexParticleThree()
{
