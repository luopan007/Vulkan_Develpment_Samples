#include "ShaderQueueSuit_CommonTexParticle.h"
#include <assert.h>
...
void ShaderQueueSuit_CommonTexParticle::create_uniform_buffer(VkDevice& device,VkPhysicalDeviceMemoryProperties& memoryroperties)
{
...
void ShaderQueueSuit_CommonTexParticle::destroy_uniform_buffer(VkDevice& device)
{
    vk::vkDestroyBuffer(device, uniformBuf, NULL);
    vk::vkFreeMemory(device, memUniformBuf, NULL);
}
void ShaderQueueSuit_CommonTexParticle::create_pipeline_layout(VkDevice& device)
{
...
void ShaderQueueSuit_CommonTexParticle::destroy_pipeline_layout(VkDevice& device)
{
...
void ShaderQueueSuit_CommonTexParticle::init_descriptor_set(VkDevice& device)
{
...
void ShaderQueueSuit_CommonTexParticle::create_shader(VkDevice& device)
{
...
void ShaderQueueSuit_CommonTexParticle::destroy_shader(VkDevice& device)
{
    vk::vkDestroyShaderModule(device, shaderStages[0].module, NULL);
    vk::vkDestroyShaderModule(device, shaderStages[1].module, NULL);
}
void ShaderQueueSuit_CommonTexParticle::initVertexAttributeInfo()
{
...
void ShaderQueueSuit_CommonTexParticle::create_pipe_line(VkDevice& device,VkRenderPass& renderPass)
{
...
void ShaderQueueSuit_CommonTexParticle::destroy_pipe_line(VkDevice& device)
{
    vk::vkDestroyPipeline(device, pipeline, NULL);
    vk::vkDestroyPipelineCache(device, pipelineCache, NULL);
}
ShaderQueueSuit_CommonTexParticle::ShaderQueueSuit_CommonTexParticle(VkDevice* deviceIn,VkRenderPass& renderPass,VkPhysicalDeviceMemoryProperties& memoryroperties)
{
...
ShaderQueueSuit_CommonTexParticle::~ShaderQueueSuit_CommonTexParticle()
{
