#ifndef VULKANEXBASE_ShaderQueueSuit_CommonTexParticleTwo_H
#define VULKANEXBASE_ShaderQueueSuit_CommonTexParticleTwo_H
#include <vector>
#include <vulkan/vulkan.h>
#include "../vksysutil/vulkan_wrapper.h"
class ShaderQueueSuit_CommonTexParticleTwo
{
private:
    VkBuffer uniformBuf;
...
public:
    ...
    VkPipeline pipeline;
    ShaderQueueSuit_CommonTexParticleTwo(VkDevice* deviceIn,VkRenderPass& renderPass,VkPhysicalDeviceMemoryProperties& memoryroperties);
    ~ShaderQueueSuit_CommonTexParticleTwo();
};
#endif
