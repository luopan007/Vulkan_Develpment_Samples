			...
			if(AInputEvent_getSource(event)==AINPUT_SOURCE_TOUCHSCREEN)
			{
				...
				switch(id)
				{
					...
					case AMOTION_EVENT_ACTION_UP:
						if(isClick)
						{
							MyVulkanManager::ScissorCenterX=x;
							MyVulkanManager::ScissorCenterY=y;
							if(x<MyVulkanManager::screenWidth/4)
								MyVulkanManager::ScissorCenterX=MyVulkanManager::screenWidth/4;
							if(x>MyVulkanManager::screenWidth/4*3)
								MyVulkanManager::ScissorCenterX=MyVulkanManager::screenWidth/4*3;
							if(y<MyVulkanManager::screenHeight/4)
								MyVulkanManager::ScissorCenterY=MyVulkanManager::screenHeight/4;
							if(y>MyVulkanManager::screenHeight/4*3)
								MyVulkanManager::ScissorCenterY=MyVulkanManager::screenHeight/4*3;
						}
					break;
				}
			}
