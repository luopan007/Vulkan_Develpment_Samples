...
void ShaderQueueSuit_SSZ::create_uniform_buffer(VkDevice& device,VkPhysicalDeviceMemoryProperties& memoryroperties)
{
...
void ShaderQueueSuit_SSZ::destroy_uniform_buffer(VkDevice& device)
{
    vk::vkDestroyBuffer(device, uniformBuf, NULL);
    vk::vkFreeMemory(device, memUniformBuf, NULL);
}
void ShaderQueueSuit_SSZ::create_pipeline_layout(VkDevice& device)
{
...
void ShaderQueueSuit_SSZ::destroy_pipeline_layout(VkDevice& device)
{
...
void ShaderQueueSuit_SSZ::init_descriptor_set(VkDevice& device)
{
...
void ShaderQueueSuit_SSZ::create_shader(VkDevice& device)
{
    std::string vertStr= FileUtil::loadAssetStr("shader/vertshadertext.vert");
    std::string fragStr= FileUtil::loadAssetStr("shader/fragshadertext.frag");
...
void ShaderQueueSuit_SSZ::create_pipe_line(VkDevice& device,VkRenderPass& renderPass)
{
...
void ShaderQueueSuit_SSZ::destroy_pipe_line(VkDevice& device)
{
    vk::vkDestroyPipeline(device, pipeline, NULL);
    vk::vkDestroyPipelineCache(device, pipelineCache, NULL);
}
ShaderQueueSuit_SSZ::ShaderQueueSuit_SSZ(VkDevice* deviceIn,VkRenderPass& renderPass,VkPhysicalDeviceMemoryProperties& memoryroperties)
{
...
ShaderQueueSuit_SSZ::~ShaderQueueSuit_SSZ()
{
