...
public:
    ...
    static ObjObject* homeObjForDraw;
    static ObjObject* bedObjForDraw;
    static ObjObject* dengObjForDraw;
    static ObjObject* book0ObjForDraw;
    static ObjObject* book1ObjForDraw;
    static ObjObject* chairObjForDraw;
    static ObjObject* borderObjForDraw;
    static TextureRect* tr;
