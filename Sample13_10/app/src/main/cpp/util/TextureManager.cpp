...
std::vector<std::string> TextureManager::texNames = { "texture/chuang.bntex","texture/deng.bntex" ,"texture/mirror.bntex" ,"texture/shu0.bntex",
                                                       "texture/shu1.bntex","texture/skybox.bntex" ,"texture/yizi.bntex" };
