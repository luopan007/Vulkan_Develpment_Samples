#ifndef VULKANEXBASE_ShaderQueueSuit_Cubemap_H
#define VULKANEXBASE_ShaderQueueSuit_Cubemap_H

#include <vector>
#include <vulkan/vulkan.h>
#include "../vksysutil/vulkan_wrapper.h"

class ShaderQueueSuit_Cubemap
{
private:
    VkBuffer uniformBuf;
  ...
  public:
    ...
    ShaderQueueSuit_Cubemap(VkDevice* deviceIn,VkRenderPass& renderPass,VkPhysicalDeviceMemoryProperties& memoryroperties);
    ~ShaderQueueSuit_Cubemap();
};
