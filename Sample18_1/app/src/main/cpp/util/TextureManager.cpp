...
std::vector<std::string> TextureManager::texNames={"texture/snooker0.bntex","texture/snooker1.bntex", "texture/snooker2.bntex","texture/snooker3.bntex","texture/snooker4.bntex","texture/snooker5.bntex" ,
                                                   "texture/snooker6.bntex","texture/green_table.bntex","texture/wall.bntex"};
