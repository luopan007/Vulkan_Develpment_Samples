...
void ShaderQueueSuit_CommonTex::create_pipe_line(VkDevice& device,VkRenderPass& renderPass)
{
    ...
    att_state[0].srcAlphaBlendFactor = VK_BLEND_FACTOR_SRC_ALPHA; //设置源 Alpha 混合因子
    att_state[0].dstAlphaBlendFactor = VK_BLEND_FACTOR_ONE_MINUS_SRC_ALPHA;//设置目标 Alpha 混合因子
