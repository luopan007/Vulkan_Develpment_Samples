#ifndef VULKANEXBASE_ShaderQueueSuit_CommonLightLIGHT_H
#define VULKANEXBASE_ShaderQueueSuit_CommonLightLIGHT_H
#include <vector>
...
public:
    ...
    VkPipeline pipeline;
    ShaderQueueSuit_CommonLight(VkDevice* deviceIn,VkRenderPass& renderPass,VkPhysicalDeviceMemoryProperties& memoryroperties);
