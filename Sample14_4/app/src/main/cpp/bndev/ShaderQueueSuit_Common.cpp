...
void ShaderQueueSuit_Common::create_uniform_buffer_vert(VkDevice& device,VkPhysicalDeviceMemoryProperties& memoryroperties)
{
...
void ShaderQueueSuit_Common::destroy_uniform_buffer_vert(VkDevice& device)
{
    vk::vkDestroyBuffer(device, uniformBuf, NULL);
    vk::vkFreeMemory(device, memUniformBuf, NULL);
}
/*创建片元着色器一致变量数据缓冲*/
void ShaderQueueSuit_Common::create_uniform_buffer_frag(VkDevice& device, VkPhysicalDeviceMemoryProperties& memoryroperties)
{
...
void ShaderQueueSuit_Common::destroy_uniform_buffer_frag(VkDevice& device)
{
...
{
    std::string vertStr= FileUtil::loadAssetStr("shader/Land.vert");
    std::string fragStr= FileUtil::loadAssetStr("shader/Land.frag");
