				...
				int32_t id = AMotionEvent_getAction(event); 					
					switch(id){
						...
						case AMOTION_EVENT_ACTION_UP:
                            if(isClick)
                            {
                                if(x<MyVulkanManager::screenWidth*0.5f&&y<MyVulkanManager::screenHeight*0.5f)
                                {
                                    MyVulkanManager::tx+=2;
                                }else if(x<MyVulkanManager::screenWidth*0.5f&&y>MyVulkanManager::screenHeight*0.5f)
                                {
                                    MyVulkanManager::tx-=2;
                                }else if(x>MyVulkanManager::screenWidth*0.5f&&y<MyVulkanManager::screenHeight*0.5f)
                                {
                                    MyVulkanManager::tz-=2;
                                }else if(x>MyVulkanManager::screenWidth*0.5f&&y>MyVulkanManager::screenHeight*0.5f)
                                {
                                    MyVulkanManager::tz+=2;
                                }
