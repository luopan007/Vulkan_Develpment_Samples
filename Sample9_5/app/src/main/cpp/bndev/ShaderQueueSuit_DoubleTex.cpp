...
void ShaderQueueSuit_DoubleTex::create_uniform_buffer(VkDevice& device, VkPhysicalDeviceMemoryProperties& memoryroperties)
{
    bufferByteCount = sizeof(float) * 3;
...
void ShaderQueueSuit_DoubleTex::destroy_uniform_buffer(VkDevice& device)
{
    vk::vkDestroyBuffer(device, uniformBuf, NULL);
    vk::vkFreeMemory(device, memUniformBuf, NULL);
}
void ShaderQueueSuit_DoubleTex::create_pipeline_layout(VkDevice& device)
{
    ...
    push_constant_ranges[0].size = sizeof(float) * 18;
...
void ShaderQueueSuit_DoubleTex::destroy_pipeline_layout(VkDevice& device)
{
...
void ShaderQueueSuit_DoubleTex::init_descriptor_set(VkDevice& device)
{
...
void ShaderQueueSuit_DoubleTex::create_shader(VkDevice& device)
{
...
void ShaderQueueSuit_DoubleTex::destroy_shader(VkDevice& device)
{
...
void ShaderQueueSuit_DoubleTex::create_pipe_line(VkDevice& device, VkRenderPass& renderPass)
{
...
void ShaderQueueSuit_DoubleTex::destroy_pipe_line(VkDevice& device)
{
    vk::vkDestroyPipeline(device, pipeline, NULL);
    vk::vkDestroyPipelineCache(device, pipelineCache, NULL);
}
ShaderQueueSuit_DoubleTex::ShaderQueueSuit_DoubleTex(VkDevice* deviceIn, VkRenderPass& renderPass, VkPhysicalDeviceMemoryProperties& memoryroperties)
{
