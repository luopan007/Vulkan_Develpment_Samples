...
class ShaderQueueSuit_CommonTexUt
{
private:
    VkBuffer uniformBuf;
...
public:
    ...
    ShaderQueueSuit_CommonTexUt(VkDevice* deviceIn,VkRenderPass& renderPass,VkPhysicalDeviceMemoryProperties& memoryroperties);
    ~ShaderQueueSuit_CommonTexUt();
};
