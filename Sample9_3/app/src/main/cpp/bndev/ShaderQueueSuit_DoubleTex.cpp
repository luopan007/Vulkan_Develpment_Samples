...
void ShaderQueueSuit_DoubleTex::create_uniform_buffer(VkDevice& device,VkPhysicalDeviceMemoryProperties& memoryroperties) { //创建一致缓冲的方法
...
void ShaderQueueSuit_DoubleTex::create_pipeline_layout(VkDevice& device){//创建管线布局
...
void ShaderQueueSuit_DoubleTex::init_descriptor_set(VkDevice& device){ //初始化描述集
