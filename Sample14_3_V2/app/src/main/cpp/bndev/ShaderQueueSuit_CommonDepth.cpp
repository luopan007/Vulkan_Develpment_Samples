...
void ShaderQueueSuit_CommonDepth::create_uniform_buffer(VkDevice& device,VkPhysicalDeviceMemoryProperties& memoryroperties)
{
...
void ShaderQueueSuit_CommonDepth::destroy_uniform_buffer(VkDevice& device)
{
    vk::vkDestroyBuffer(device, uniformBuf, NULL);
    vk::vkFreeMemory(device, memUniformBuf, NULL);
}
void ShaderQueueSuit_CommonDepth::create_pipeline_layout(VkDevice& device)
{
...
void ShaderQueueSuit_CommonDepth::destroy_pipeline_layout(VkDevice& device)
{
...
void ShaderQueueSuit_CommonDepth::init_descriptor_set(VkDevice& device)
{
...
void ShaderQueueSuit_CommonDepth::create_shader(VkDevice& device)
{
    std::string vertStr= FileUtil::loadAssetStr("shader/commonDepth.vert");
    std::string fragStr= FileUtil::loadAssetStr("shader/commonDepth.frag");
...
void ShaderQueueSuit_CommonDepth::destroy_shader(VkDevice& device)
{
    vk::vkDestroyShaderModule(device, shaderStages[0].module, NULL);
    vk::vkDestroyShaderModule(device, shaderStages[1].module, NULL);
}
void ShaderQueueSuit_CommonDepth::initVertexAttributeInfo()
{
...
void ShaderQueueSuit_CommonDepth::create_pipe_line(VkDevice& device,VkRenderPass& renderPass)
{
...
void ShaderQueueSuit_CommonDepth::destroy_pipe_line(VkDevice& device)
{
    vk::vkDestroyPipeline(device, pipeline, NULL);
    vk::vkDestroyPipelineCache(device, pipelineCache, NULL);
}
ShaderQueueSuit_CommonDepth::ShaderQueueSuit_CommonDepth(VkDevice* deviceIn,VkRenderPass& renderPass,VkPhysicalDeviceMemoryProperties& memoryroperties)
{
...
ShaderQueueSuit_CommonDepth::~ShaderQueueSuit_CommonDepth()
{
