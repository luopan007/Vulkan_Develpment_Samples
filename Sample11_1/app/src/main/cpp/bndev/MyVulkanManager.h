...
class MyVulkanManager
{
  public:
    ...
    static ShaderQueueSuit_CommonTex_X* sqsCT;
    static ShaderQueueSuit_CommonTex_XY* sqsXY;
    static ShaderQueueSuit_CommonTex_Xie* sqsXie;
    static TexDrawableObject* texTri;
    static float yAngle;
    static float zAngle;
    static float uWidthSpan;
    static float uStartAngle;
    static int isSwap;
