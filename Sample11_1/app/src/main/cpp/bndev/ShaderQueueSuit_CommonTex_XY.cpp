#include "ShaderQueueSuit_CommonTex_XY.h"
#include <assert.h>
...
void ShaderQueueSuit_CommonTex_XY::create_uniform_buffer(VkDevice& device,VkPhysicalDeviceMemoryProperties& memoryroperties)
{
...
void ShaderQueueSuit_CommonTex_XY::destroy_uniform_buffer(VkDevice& device)
{
    vk::vkDestroyBuffer(device, uniformBuf, NULL);
    vk::vkFreeMemory(device, memUniformBuf, NULL);
}
void ShaderQueueSuit_CommonTex_XY::create_pipeline_layout(VkDevice& device)
{
...
void ShaderQueueSuit_CommonTex_XY::destroy_pipeline_layout(VkDevice& device)
{
...
void ShaderQueueSuit_CommonTex_XY::init_descriptor_set(VkDevice& device)
{
...
void ShaderQueueSuit_CommonTex_XY::create_shader(VkDevice& device)
{
    std::string vertStr= FileUtil::loadAssetStr("shader/commonTexXY.vert");
...
void ShaderQueueSuit_CommonTex_XY::destroy_shader(VkDevice& device)
{
    vk::vkDestroyShaderModule(device, shaderStages[0].module, NULL);
    vk::vkDestroyShaderModule(device, shaderStages[1].module, NULL);
}
void ShaderQueueSuit_CommonTex_XY::initVertexAttributeInfo()
{
...
void ShaderQueueSuit_CommonTex_XY::create_pipe_line(VkDevice& device,VkRenderPass& renderPass)
{
...
void ShaderQueueSuit_CommonTex_XY::destroy_pipe_line(VkDevice& device)
{
    vk::vkDestroyPipeline(device, pipeline, NULL);
    vk::vkDestroyPipelineCache(device, pipelineCache, NULL);
}
ShaderQueueSuit_CommonTex_XY::ShaderQueueSuit_CommonTex_XY(VkDevice* deviceIn,VkRenderPass& renderPass,VkPhysicalDeviceMemoryProperties& memoryroperties)
{
...
ShaderQueueSuit_CommonTex_XY::~ShaderQueueSuit_CommonTex_XY()
{
