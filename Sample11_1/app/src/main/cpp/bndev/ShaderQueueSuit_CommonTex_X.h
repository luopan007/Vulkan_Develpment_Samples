#ifndef VULKANEXBASE_ShaderQueueSuit_CommonTex_X_H
#define VULKANEXBASE_ShaderQueueSuit_CommonTex_X_H
#include <vector>
#include <vulkan/vulkan.h>
#include "../vksysutil/vulkan_wrapper.h"
class ShaderQueueSuit_CommonTex_X
{
private:
    VkBuffer uniformBuf;
  ...
  public:
    ...
    VkPipeline pipeline;
    ShaderQueueSuit_CommonTex_X(VkDevice* deviceIn,VkRenderPass& renderPass,VkPhysicalDeviceMemoryProperties& memoryroperties);
    ~ShaderQueueSuit_CommonTex_X();
};
#endif
