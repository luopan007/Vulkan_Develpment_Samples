...
void MyVulkanManager::drawSceneToTex()
{
    ...
    LightManager::setLightPosition(1,30);
    LightManager::getTYJZ(screenWidth*1.0/screenHeight);
    ...
    CHForDraw->drawSelf(cmdBuffer,sqsCD->pipelineLayout,sqsCD->pipeline,
...
void MyVulkanManager::drawSceneToScreen()
{
    ...
    CHForDraw->drawSelf(cmdBuffer,sqsCTL->pipelineLayout,sqsCTL->pipeline,
                        &(sqsCTL->descSet[TextureManager::getVkDescriptorSetIndexForCommonTexLight("texture/ghxp.bntex")]),false);
    MatrixState3D::popMatrix();
    MatrixState3D::pushMatrix();
    MatrixState3D::translate(-87,0,50);
