...
layout (location = 4) out vec3 vlightPosition;
layout (location = 5) out vec4 vlightAmbient;
...
void main() {
    ...
    vPosition=myConstantVals.mm*vec4(pos,1.0);
    vlightPosition=myBufferVals.lightPosition.xyz;
    vlightAmbient=myBufferVals.lightAmbient;
