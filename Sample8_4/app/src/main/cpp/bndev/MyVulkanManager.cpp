...
ColorObject* MyVulkanManager::rectForDraw2;
...
void MyVulkanManager::createDrawableObject()
{
    ...
    rectForDraw2 = new ColorObject(RectData::vdata,RectData::dataByteCount,RectData::vCount,device,memoryroperties);
...
void MyVulkanManager::drawObject()
{
    ...
    while(MyVulkanManager::loopDrawFlag)
    {
        ...
        MatrixState3D::scale(8, 8, 8);    
        MatrixState3D::pushMatrix();
        MatrixState3D::translate(-12, 0, 0);
        ...
        MatrixState3D::popMatrix();
        MatrixState3D::pushMatrix();
        MatrixState3D::translate(0, 0, -12);
        ...
        MatrixState3D::scale(2, 1.7, 1);
        rectForDraw2->drawSelf(cmdBuffer,sqsCTL->pipelineLayout,sqsCTL->pipeline);
        MatrixState3D::popMatrix();
        MatrixState3D::popMatrix();
