...
void setImageLayout(VkCommandBuffer cmd, VkImage image,VkImageAspectFlags aspectMask,
    ...
    vk::vkCmdPipelineBarrier(cmd, src_stages, dest_stages, 0, 0,
                             NULL, 0, NULL, 1, &image_memory_barrier);
}
std::vector<std::string> TextureManager::texNames={"texture/floor.bntex","texture/sky_cloud.bntex","texture/blackboard.bntex","texture/roof.bntex","texture/window.bntex","texture/whiteboard.bntex","texture/flag.bntex","texture/chair.bntex","texture/glass.bntex"};
std::vector<std::string> TextureManager::texNamesForCommonTexLight={"texture/floor.bntex","texture/blackboard.bntex","texture/roof.bntex","texture/window.bntex","texture/whiteboard.bntex","texture/flag.bntex","texture/chair.bntex","texture/glass.bntex"};
std::vector<std::string> TextureManager::texNamesForSky={"texture/sky_cloud.bntex"};
...
void TextureManager::init_SPEC_2D_Textures(std::string texName, VkDevice& device, VkPhysicalDevice& gpu, VkPhysicalDeviceMemoryProperties& memoryroperties, VkCommandBuffer& cmdBuffer, VkQueue& queueGraphics,VkFormat format, TexDataObject* ctdo)
{
    ...
    if (needStaging)
    {
        ...
        vk::vkCmdCopyBufferToImage(cmdBuffer, tempBuf,
