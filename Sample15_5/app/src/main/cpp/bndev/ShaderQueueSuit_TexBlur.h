...
private:
  ...
  public:
    ...
    VkPipeline pipeline;
    ShaderQueueSuit_TexBlur(VkDevice* deviceIn,VkRenderPass& renderPass,VkPhysicalDeviceMemoryProperties& memoryroperties);
    ~ShaderQueueSuit_TexBlur();
};
#endif
