...
void ShaderQueueSuit_Sky::create_uniform_buffer(VkDevice& device,VkPhysicalDeviceMemoryProperties& memoryroperties)
{
...
void ShaderQueueSuit_Sky::destroy_uniform_buffer(VkDevice& device)
{
    vk::vkDestroyBuffer(device, uniformBuf, NULL);
    vk::vkFreeMemory(device, memUniformBuf, NULL);
}
void ShaderQueueSuit_Sky::create_pipeline_layout(VkDevice& device)
{
...
void ShaderQueueSuit_Sky::destroy_pipeline_layout(VkDevice& device)
{
...
void ShaderQueueSuit_Sky::init_descriptor_set(VkDevice& device)
{
...
void ShaderQueueSuit_Sky::create_shader(VkDevice& device)
{
    std::string vertStr= FileUtil::loadAssetStr("shader/sky.vert");
    std::string fragStr= FileUtil::loadAssetStr("shader/sky.frag");
...
void ShaderQueueSuit_Sky::create_pipe_line(VkDevice& device,VkRenderPass& renderPass)
{
...
void ShaderQueueSuit_Sky::destroy_pipe_line(VkDevice& device)
{
    vk::vkDestroyPipeline(device, pipeline, NULL);
    vk::vkDestroyPipelineCache(device, pipelineCache, NULL);
}
ShaderQueueSuit_Sky::ShaderQueueSuit_Sky(VkDevice* deviceIn,VkRenderPass& renderPass,VkPhysicalDeviceMemoryProperties& memoryroperties)
{
...
ShaderQueueSuit_Sky::~ShaderQueueSuit_Sky()
{
