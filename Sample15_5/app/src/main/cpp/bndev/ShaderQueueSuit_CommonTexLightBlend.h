#ifndef SAMPLE17_3_ShaderQueueSuit_CommonTexLightBlendBLEND_H
#define SAMPLE17_3_ShaderQueueSuit_CommonTexLightBlendBLEND_H
#include <vector>
#include <vulkan/vulkan.h>
#include "../vksysutil/vulkan_wrapper.h"
class ShaderQueueSuit_CommonTexLightBlend
{
private:
    VkBuffer uniformBuf;
...
public:
    ...
    VkPipeline pipeline;
    ShaderQueueSuit_CommonTexLightBlend(VkDevice* deviceIn,VkRenderPass& renderPass,VkPhysicalDeviceMemoryProperties& memoryroperties);
    ~ShaderQueueSuit_CommonTexLightBlend();
};
#endif 
