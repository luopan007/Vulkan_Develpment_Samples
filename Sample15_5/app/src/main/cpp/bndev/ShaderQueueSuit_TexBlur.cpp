...
void ShaderQueueSuit_TexBlur::create_uniform_buffer(VkDevice& device,VkPhysicalDeviceMemoryProperties& memoryroperties)
{
    bufferByteCount=sizeof(float)*8;
...
void ShaderQueueSuit_TexBlur::destroy_uniform_buffer(VkDevice& device)
{
    vk::vkDestroyBuffer(device, uniformBuf, NULL);
    vk::vkFreeMemory(device, memUniformBuf, NULL);
}
void ShaderQueueSuit_TexBlur::create_pipeline_layout(VkDevice& device)
{
...
void ShaderQueueSuit_TexBlur::destroy_pipeline_layout(VkDevice& device)
{
...
void ShaderQueueSuit_TexBlur::init_descriptor_set(VkDevice& device)
{
...
void ShaderQueueSuit_TexBlur::create_shader(VkDevice& device)
{
    std::string vertStr= FileUtil::loadAssetStr("shader/TexBlur.vert");
    std::string fragStr= FileUtil::loadAssetStr("shader/TexBlur.frag");
...
void ShaderQueueSuit_TexBlur::create_pipe_line(VkDevice& device,VkRenderPass& renderPass)
{
...
void ShaderQueueSuit_TexBlur::destroy_pipe_line(VkDevice& device)
{
    vk::vkDestroyPipeline(device, pipeline, NULL);
    vk::vkDestroyPipelineCache(device, pipelineCache, NULL);
}
ShaderQueueSuit_TexBlur::ShaderQueueSuit_TexBlur(VkDevice* deviceIn,VkRenderPass& renderPass,VkPhysicalDeviceMemoryProperties& memoryroperties)
{
...
ShaderQueueSuit_TexBlur::~ShaderQueueSuit_TexBlur()
{
