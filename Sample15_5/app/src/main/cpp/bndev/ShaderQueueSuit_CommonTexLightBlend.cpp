...
void ShaderQueueSuit_CommonTexLightBlend::create_uniform_buffer(VkDevice& device,VkPhysicalDeviceMemoryProperties& memoryroperties)
{
...
void ShaderQueueSuit_CommonTexLightBlend::destroy_uniform_buffer(VkDevice& device)
{
    vk::vkDestroyBuffer(device, uniformBuf, NULL);
    vk::vkFreeMemory(device, memUniformBuf, NULL);
}
void ShaderQueueSuit_CommonTexLightBlend::create_pipeline_layout(VkDevice& device)
{
...
void ShaderQueueSuit_CommonTexLightBlend::destroy_pipeline_layout(VkDevice& device)
{
...
void ShaderQueueSuit_CommonTexLightBlend::init_descriptor_set(VkDevice& device)
{
...
void ShaderQueueSuit_CommonTexLightBlend::create_shader(VkDevice& device)
{
...
void ShaderQueueSuit_CommonTexLightBlend::destroy_shader(VkDevice& device)
{
    vk::vkDestroyShaderModule(device, shaderStages[0].module, NULL);
    vk::vkDestroyShaderModule(device, shaderStages[1].module, NULL);
}
void ShaderQueueSuit_CommonTexLightBlend::initVertexAttributeInfo()
{
...
void ShaderQueueSuit_CommonTexLightBlend::create_pipe_line(VkDevice& device,VkRenderPass& renderPass)
{
...
void ShaderQueueSuit_CommonTexLightBlend::destroy_pipe_line(VkDevice& device)
{
    vk::vkDestroyPipeline(device, pipeline, NULL);
    vk::vkDestroyPipelineCache(device, pipelineCache, NULL);
}
ShaderQueueSuit_CommonTexLightBlend::ShaderQueueSuit_CommonTexLightBlend(VkDevice* deviceIn,VkRenderPass& renderPass,VkPhysicalDeviceMemoryProperties& memoryroperties)
{
...
ShaderQueueSuit_CommonTexLightBlend::~ShaderQueueSuit_CommonTexLightBlend()
{
