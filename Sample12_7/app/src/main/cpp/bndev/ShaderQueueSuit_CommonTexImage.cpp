...
void ShaderQueueSuit_CommonTexImage::create_uniform_buffer(VkDevice& device,VkPhysicalDeviceMemoryProperties& memoryroperties)
{
...
void ShaderQueueSuit_CommonTexImage::destroy_uniform_buffer(VkDevice& device)
{
    vk::vkDestroyBuffer(device, uniformBuf, NULL);
    vk::vkFreeMemory(device, memUniformBuf, NULL);
}
void ShaderQueueSuit_CommonTexImage::create_pipeline_layout(VkDevice& device)
{
...
void ShaderQueueSuit_CommonTexImage::destroy_pipeline_layout(VkDevice& device)
{
...
void ShaderQueueSuit_CommonTexImage::init_descriptor_set(VkDevice& device)
{
...
void ShaderQueueSuit_CommonTexImage::create_shader(VkDevice& device)
{
    std::string vertStr= FileUtil::loadAssetStr("shader/commonTexImage.vert");
    std::string fragStr= FileUtil::loadAssetStr("shader/commonTexImage.frag");
...
void ShaderQueueSuit_CommonTexImage::destroy_shader(VkDevice& device)
{
    vk::vkDestroyShaderModule(device, shaderStages[0].module, NULL);
    vk::vkDestroyShaderModule(device, shaderStages[1].module, NULL);
}
void ShaderQueueSuit_CommonTexImage::initVertexAttributeInfo()
{
...
void ShaderQueueSuit_CommonTexImage::create_pipe_line(VkDevice& device,VkRenderPass& renderPass)
{
...
void ShaderQueueSuit_CommonTexImage::destroy_pipe_line(VkDevice& device)
{
    vk::vkDestroyPipeline(device, pipeline, NULL);
    vk::vkDestroyPipelineCache(device, pipelineCache, NULL);
}
ShaderQueueSuit_CommonTexImage::ShaderQueueSuit_CommonTexImage(VkDevice* deviceIn,VkRenderPass& renderPass,VkPhysicalDeviceMemoryProperties& memoryroperties)
{
...
ShaderQueueSuit_CommonTexImage::~ShaderQueueSuit_CommonTexImage()
{
