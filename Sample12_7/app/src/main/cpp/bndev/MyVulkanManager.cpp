...
void MyVulkanManager::drawObject()
{
    ...
    while(MyVulkanManager::loopDrawFlag)
    {
        ...
        MatrixState3D::translate(-3.3,3.3,0);
        texTri->drawSelf(cmdBuffer,sqsCT->pipelineLayout,sqsCT->pipeline, &(sqsCT->descSet[TextureManager::getVkDescriptorSetIndex("texture/object.bntex")]));
        MatrixState3D::translate(6.6,0,0);
        texTri->drawSelf(cmdBuffer,sqsImage->pipelineLayout,sqsImage->pipeline, &(sqsImage->descSet[TextureManager::getVkDescriptorSetIndex("texture/object.bntex")]));
        MatrixState3D::translate(0,-6.6,0);
        texTri->drawSelf(cmdBuffer,sqsImage->pipelineLayout,sqsImage->pipeline, &(sqsImage->descSet[TextureManager::getVkDescriptorSetIndex("texture/object1.bntex")]));
        MatrixState3D::translate(-6.6,0,0);
        texTri->drawSelf(cmdBuffer,sqsCT->pipelineLayout,sqsCT->pipeline, &(sqsCT->descSet[TextureManager::getVkDescriptorSetIndex("texture/object1.bntex")]));
