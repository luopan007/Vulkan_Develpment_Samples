...
std::vector<std::string> TextureManager::texNames={"texture/snow.bntex","texture/mountain.bntex","texture/sky.bntex"};
std::vector<std::string> TextureManager::texNamesForCommonTexLight={"texture/mountain.bntex","texture/sky.bntex"};
std::vector<std::string> TextureManager::texNamesForSnow={"texture/snow.bntex"};
std::vector<std::string> TextureManager::texNamesForSky={"texture/sky.bntex"};
...
int TextureManager::getVkDescriptorSetIndexForCOmmonTex(std::string texName)
{
    return  getVkDescriptorSetIndexGeneral(texName,texNamesForSky);
}