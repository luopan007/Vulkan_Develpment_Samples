...
public:
    ...
    static std::vector<std::string> texNamesForSnow;
    static std::vector<std::string> texNamesForSky;
    ...
    static int getVkDescriptorSetIndexForCOmmonTex(std::string texName);
private:
