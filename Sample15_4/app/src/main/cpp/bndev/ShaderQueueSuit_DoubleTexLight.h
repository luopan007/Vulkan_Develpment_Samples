#ifndef SAMPLE17_2_SHADERQUEUESUIT_DOUBLETEXLIGHT_H
#define SAMPLE17_2_SHADERQUEUESUIT_DOUBLETEXLIGHT_H
#include <vector>
#include <vulkan/vulkan.h>
class ShaderQueueSuit_DoubleTexLight
{
private:
    VkBuffer uniformBuf;
...
public:
    ...
    VkPipeline pipeline;
    ShaderQueueSuit_DoubleTexLight(VkDevice* deviceIn, VkRenderPass& renderPass, VkPhysicalDeviceMemoryProperties& memoryroperties);
    ~ShaderQueueSuit_DoubleTexLight();
};
#endif 
