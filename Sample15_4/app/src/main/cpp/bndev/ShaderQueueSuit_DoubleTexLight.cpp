...
void ShaderQueueSuit_DoubleTexLight::create_uniform_buffer(VkDevice& device, VkPhysicalDeviceMemoryProperties& memoryroperties)
{
...
void ShaderQueueSuit_DoubleTexLight::destroy_uniform_buffer(VkDevice& device)
{
    vk::vkDestroyBuffer(device, uniformBuf, NULL);
    vk::vkFreeMemory(device, memUniformBuf, NULL);
}
void ShaderQueueSuit_DoubleTexLight::create_pipeline_layout(VkDevice& device)
{
...
void ShaderQueueSuit_DoubleTexLight::destroy_pipeline_layout(VkDevice& device)
{
...
void ShaderQueueSuit_DoubleTexLight::init_descriptor_set(VkDevice& device)
{
...
void ShaderQueueSuit_DoubleTexLight::create_shader(VkDevice& device)
{
    std::string vertStr = FileUtil::loadAssetStr("shader/DoubleTexLight.vert");
    std::string fragStr = FileUtil::loadAssetStr("shader/DoubleTexLight.frag");
...
void ShaderQueueSuit_DoubleTexLight::destroy_shader(VkDevice& device)
{
    vk::vkDestroyShaderModule(device, shaderStages[0].module, NULL);
    vk::vkDestroyShaderModule(device, shaderStages[1].module, NULL);
}
void ShaderQueueSuit_DoubleTexLight::initVertexAttributeInfo()
{
...
void ShaderQueueSuit_DoubleTexLight::create_pipe_line(VkDevice& device, VkRenderPass& renderPass)
{
...
void ShaderQueueSuit_DoubleTexLight::destroy_pipe_line(VkDevice& device)
{
    vk::vkDestroyPipeline(device, pipeline, NULL);
    vk::vkDestroyPipelineCache(device, pipelineCache, NULL);
}
ShaderQueueSuit_DoubleTexLight::ShaderQueueSuit_DoubleTexLight(VkDevice* deviceIn, VkRenderPass& renderPass, VkPhysicalDeviceMemoryProperties& memoryroperties)
{
...
ShaderQueueSuit_DoubleTexLight::~ShaderQueueSuit_DoubleTexLight()
{
