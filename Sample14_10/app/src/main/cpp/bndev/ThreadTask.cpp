...
void ThreadTask::doTask()
{
    ...
    MyVulkanManager::create_vulkan_aoFactorBuffer();
    MyVulkanManager::create_render_pass_screen();
    MyVulkanManager::create_render_pass_self();
    MyVulkanManager::create_render_pass_aoFactor();
    ...
    MyVulkanManager::destroy_render_pass_aoFactor();
    MyVulkanManager::destroy_vulkan_DepthBuffer();
    MyVulkanManager::destroy_vulkan_aoFactorBuffer();
