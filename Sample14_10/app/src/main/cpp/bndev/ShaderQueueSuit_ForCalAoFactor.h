#ifndef VULKANEXBASE_SHADERQUEUESUIT_ForCalAoFactor_H
#define VULKANEXBASE_SHADERQUEUESUIT_ForCalAoFactor_H
#include <vector>
#include <vulkan/vulkan.h>
class ShaderQueueSuit_ForCalAoFactor
{
private:
    VkBuffer uniformBuf;
...
public:
    ...
    VkPipeline pipeline;
    ShaderQueueSuit_ForCalAoFactor(VkDevice* deviceIn,VkRenderPass& renderPass,VkPhysicalDeviceMemoryProperties& memoryroperties);
    ~ShaderQueueSuit_ForCalAoFactor();
};
#endif
