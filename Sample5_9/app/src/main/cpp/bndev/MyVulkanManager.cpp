...
void MyVulkanManager::createDrawableObject()
{
    ...
    FlatData::genData();
    objForDraw=new DrawableObjectCommonLight(FlatData::vdata,FlatData::dataByteCount,FlatData::vCount,device,memoryroperties);
}
...
void MyVulkanManager::initMatrixAndLight()
{
    ...
    LightManager::setLightPosition(0,0,-14.5f);
