...
std::vector<std::string> TextureManager::texNames={"texture/dog.bntex","texture/floor.bntex"};
std::vector<std::string> TextureManager::texNamesForCommonTexLight={"texture/dog.bntex","texture/floor.bntex"};
