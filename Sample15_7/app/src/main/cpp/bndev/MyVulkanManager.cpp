...
ObjObject*  MyVulkanManager::objObjectDog;
ObjObject*  MyVulkanManager::objObjectPM;
float MyVulkanManager::isToneMapping=0;
...
void MyVulkanManager::createDrawableObject(){
    objObjectDog	 = LoadUtil::loadFromFile("model/dog.obj", device, memoryroperties);
...
void MyVulkanManager::initMatrixAndLight()
{
    ...
    LightManager::setLightPosition(0,300,0);
    LightManager::setlightAmbient(2.0f,2.0f,2.0f,2.0f);
...
{
    float vertexUniformDataShadow[40]=
            {
                    MatrixState3D::CX,MatrixState3D::CY,MatrixState3D::CZ,isToneMapping,
                    ...
                    LightManager::disX-LightManager::lx,LightManager::disY-LightManager::ly,LightManager::disZ-LightManager::lz,1.0,
...
void MyVulkanManager::drawObject()
{
    ...
    while(MyVulkanManager::loopDrawFlag)
    {
        ...
        objObjectPM->drawSelf(cmdBuffer, sqsCT->pipelineLayout, sqsCT->pipeline,
                              &(sqsCT->descSet[TextureManager::getVkDescriptorSetIndexForCommonTexLight("texture/floor.bntex")]),0);
        MatrixState3D::popMatrix();
        MatrixState3D::pushMatrix();
        MatrixState3D::scale(4.0f, 4.0f, 4.0f);
        objObjectDog->drawSelf(cmdBuffer, sqsCT->pipelineLayout, sqsCT->pipeline,
                               &(sqsCT->descSet[TextureManager::getVkDescriptorSetIndexForCommonTexLight("texture/dog.bntex")]),1);
        MatrixState3D::popMatrix();
        MatrixState3D::pushMatrix();
        MatrixState3D::scale(4.0f, 4.0f, 4.0f);
        objObjectDog->drawSelf(cmdBuffer, sqsCT->pipelineLayout, sqsCT->pipeline,
                               &(sqsCT->descSet[TextureManager::getVkDescriptorSetIndexForCommonTexLight("texture/dog.bntex")]),0);
        MatrixState3D::popMatrix();
