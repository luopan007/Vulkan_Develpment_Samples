#include "ShaderQueueSuit_Cubemap.h"
#include <assert.h>
...
void ShaderQueueSuit_Cubemap::create_uniform_buffer(VkDevice& device,VkPhysicalDeviceMemoryProperties& memoryroperties)
{
...
void ShaderQueueSuit_Cubemap::destroy_uniform_buffer(VkDevice& device)
{
...
void ShaderQueueSuit_Cubemap::create_pipeline_layout(VkDevice& device)
{
...
void ShaderQueueSuit_Cubemap::destroy_pipeline_layout(VkDevice& device)
{
...
void ShaderQueueSuit_Cubemap::init_descriptor_set(VkDevice& device)
{

    VkDescriptorPoolSize type_count[2];
    type_count[0].type = VK_DESCRIPTOR_TYPE_UNIFORM_BUFFER;
    type_count[0].descriptorCount = TextureManager::texNamesForCubeMap.size();
    type_count[1].type = VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER;
    type_count[1].descriptorCount = TextureManager::texNamesForCubeMap.size();


    VkDescriptorPoolCreateInfo descriptor_pool = {};
    descriptor_pool.sType = VK_STRUCTURE_TYPE_DESCRIPTOR_POOL_CREATE_INFO;
    descriptor_pool.pNext = NULL;
    descriptor_pool.maxSets = TextureManager::texNamesForCubeMap.size();
    ...
    alloc_info[0].descriptorSetCount = TextureManager::texNamesForCubeMap.size();
    alloc_info[0].pSetLayouts = layouts.data();


    descSet.resize(TextureManager::texNamesForCubeMap.size());
...
void ShaderQueueSuit_Cubemap::create_shader(VkDevice& device)
{
    std::string vertStr= FileUtil::loadAssetStr("shader/cubemap.vert");
    std::string fragStr= FileUtil::loadAssetStr("shader/cubemap.frag");
...
void ShaderQueueSuit_Cubemap::create_pipe_line(VkDevice& device,VkRenderPass& renderPass)
{
...
void ShaderQueueSuit_Cubemap::destroy_pipe_line(VkDevice& device)
{
...
ShaderQueueSuit_Cubemap::ShaderQueueSuit_Cubemap(VkDevice* deviceIn,VkRenderPass& renderPass,VkPhysicalDeviceMemoryProperties& memoryroperties)
{
...
ShaderQueueSuit_Cubemap::~ShaderQueueSuit_Cubemap()
{
