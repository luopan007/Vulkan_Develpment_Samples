...
{
    objObject=LoadUtil::loadFromFile("model/rect.obj",device,memoryroperties);
    objObjectUt=LoadUtil::loadFromFileUt("model/rect.obj",device,memoryroperties);
}
...
void MyVulkanManager::drawObject()
{
    ...
    while(MyVulkanManager::loopDrawFlag){
        ...
        MatrixState3D::translate(-10, 0, -40);
