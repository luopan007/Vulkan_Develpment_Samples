...
public:
    ...
    static VkQueryPool queryPool;//查询池对象
    static int* queryResultData;//存放查询结果数据的数组
    static int queryCount;//查询数量
    ...
    static ShaderQueueSuit_ForQuery* sqsFQ;
    static ObjObject* objObjectZDT;
    static ObjObject* objObjectQT;
    ...
    static void creat_QueryPool();//创建查询池的方法
    ...
    static void destroy_QueryPool();//销毁查询池的方法
...
private:
    static void getQueryResult();//获取查询结果的方法
    static void drawOcclusionObj();//绘制遮挡体
    static void drawForQuery();
    static void drawForPresent();
};
#endif 
