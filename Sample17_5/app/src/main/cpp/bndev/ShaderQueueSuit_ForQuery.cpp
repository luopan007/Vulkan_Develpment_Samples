...
void ShaderQueueSuit_ForQuery::create_pipeline_layout(VkDevice& device)
{
...
void ShaderQueueSuit_ForQuery::destroy_pipeline_layout(VkDevice& device)
{
...
void ShaderQueueSuit_ForQuery::init_descriptor_set(VkDevice& device)
{
    VkDescriptorPoolCreateInfo descriptor_pool = {};
    descriptor_pool.sType = VK_STRUCTURE_TYPE_DESCRIPTOR_POOL_CREATE_INFO;
    descriptor_pool.pNext = NULL;
    descriptor_pool.maxSets = TextureManager::texNames.size();
    descriptor_pool.poolSizeCount = 0;
    descriptor_pool.pPoolSizes = NULL;
...
void ShaderQueueSuit_ForQuery::create_shader(VkDevice& device)
{
    std::string vertStr= FileUtil::loadAssetStr("shader/forQuery.vert");
    std::string fragStr= FileUtil::loadAssetStr("shader/forQuery.frag");
...
void ShaderQueueSuit_ForQuery::create_pipe_line(VkDevice& device,VkRenderPass& renderPass)
{
...
void ShaderQueueSuit_ForQuery::destroy_pipe_line(VkDevice& device)
{
    vk::vkDestroyPipeline(device, pipeline, NULL);
    vk::vkDestroyPipelineCache(device, pipelineCache, NULL);
}
ShaderQueueSuit_ForQuery::ShaderQueueSuit_ForQuery(VkDevice* deviceIn,VkRenderPass& renderPass,VkPhysicalDeviceMemoryProperties& memoryroperties)
{
...
ShaderQueueSuit_ForQuery::~ShaderQueueSuit_ForQuery()
{
