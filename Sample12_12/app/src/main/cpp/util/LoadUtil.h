...
public:
    ...
    static ObjObject* loadFromFileVertex(const string& fname,VkDevice& device,VkPhysicalDeviceMemoryProperties& memoryroperties);
    static ObjObject* loadFromFileVertexAndTex(const string& fname,VkDevice& device,VkPhysicalDeviceMemoryProperties& memoryroperties);
    static ObjObject* loadFromFileVertexAndNormal(const string& fname,VkDevice& device,VkPhysicalDeviceMemoryProperties& memoryroperties);
