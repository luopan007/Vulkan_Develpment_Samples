...
std::vector<std::string> TextureManager::texNames={"texture/floor.bntex","texture/people.bntex","texture/brick.bntex"};
std::vector<std::string> TextureManager::texNamesForCommonTexLight={"texture/floor.bntex","texture/people.bntex","texture/brick.bntex"};
