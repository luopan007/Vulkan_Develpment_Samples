...
void ShaderQueueSuit_CommonTexLight_Depth::create_uniform_buffer(VkDevice& device,VkPhysicalDeviceMemoryProperties& memoryroperties)
{
...
void ShaderQueueSuit_CommonTexLight_Depth::destroy_uniform_buffer(VkDevice& device)
{
    vk::vkDestroyBuffer(device, uniformBuf, NULL);
    vk::vkFreeMemory(device, memUniformBuf, NULL);
}
void ShaderQueueSuit_CommonTexLight_Depth::create_pipeline_layout(VkDevice& device)
{
...
void ShaderQueueSuit_CommonTexLight_Depth::destroy_pipeline_layout(VkDevice& device)
{
...
void ShaderQueueSuit_CommonTexLight_Depth::init_descriptor_set(VkDevice& device)
{
...
void ShaderQueueSuit_CommonTexLight_Depth::create_shader(VkDevice& device)
{
    ...
    SpvData spvVertData=FileUtil::loadSPV("shader/commonTexLightDepth.vert.spv");
    ...
    SpvData spvFragData=FileUtil::loadSPV("shader/commonTexLightDepth.frag.spv");
    moduleCreateInfo.sType = VK_STRUCTURE_TYPE_SHADER_MODULE_CREATE_INFO;
    moduleCreateInfo.pNext = NULL;
    moduleCreateInfo.flags = 0;
...
void ShaderQueueSuit_CommonTexLight_Depth::destroy_shader(VkDevice& device)
{
    vk::vkDestroyShaderModule(device, shaderStages[0].module, NULL);
    vk::vkDestroyShaderModule(device, shaderStages[1].module, NULL);
}
void ShaderQueueSuit_CommonTexLight_Depth::initVertexAttributeInfo()
{
...
void ShaderQueueSuit_CommonTexLight_Depth::create_pipe_line(VkDevice& device,VkRenderPass& renderPass)
{
...
void ShaderQueueSuit_CommonTexLight_Depth::destroy_pipe_line(VkDevice& device)
{
    vk::vkDestroyPipeline(device, pipeline, NULL);
    vk::vkDestroyPipelineCache(device, pipelineCache, NULL);
}
ShaderQueueSuit_CommonTexLight_Depth::ShaderQueueSuit_CommonTexLight_Depth(VkDevice* deviceIn,VkRenderPass& renderPass,VkPhysicalDeviceMemoryProperties& memoryroperties)
{
...
ShaderQueueSuit_CommonTexLight_Depth::~ShaderQueueSuit_CommonTexLight_Depth()
{
