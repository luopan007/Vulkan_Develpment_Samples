...
private:
  ...
  public:
    ...
    VkPipeline pipeline;
    ShaderQueueSuit_TexRect(VkDevice* deviceIn,VkRenderPass& renderPass,VkPhysicalDeviceMemoryProperties& memoryroperties);
    ~ShaderQueueSuit_TexRect();
};
#endif
