...
void ShaderQueueSuit_TexRect::create_uniform_buffer(VkDevice& device,VkPhysicalDeviceMemoryProperties& memoryroperties)
{
...
void ShaderQueueSuit_TexRect::destroy_uniform_buffer(VkDevice& device)
{
    vk::vkDestroyBuffer(device, uniformBuf, NULL);
    vk::vkFreeMemory(device, memUniformBuf, NULL);
}
void ShaderQueueSuit_TexRect::create_pipeline_layout(VkDevice& device)
{
...
void ShaderQueueSuit_TexRect::destroy_pipeline_layout(VkDevice& device)
{
...
void ShaderQueueSuit_TexRect::init_descriptor_set(VkDevice& device)
{
...
void ShaderQueueSuit_TexRect::create_shader(VkDevice& device)
{
    std::string vertStr= FileUtil::loadAssetStr("shader/TexRect.vert");
    std::string fragStr= FileUtil::loadAssetStr("shader/TexRect.frag");
...
void ShaderQueueSuit_TexRect::create_pipe_line(VkDevice& device,VkRenderPass& renderPass)
{
...
void ShaderQueueSuit_TexRect::destroy_pipe_line(VkDevice& device)
{
    vk::vkDestroyPipeline(device, pipeline, NULL);
    vk::vkDestroyPipelineCache(device, pipelineCache, NULL);
}
ShaderQueueSuit_TexRect::ShaderQueueSuit_TexRect(VkDevice* deviceIn,VkRenderPass& renderPass,VkPhysicalDeviceMemoryProperties& memoryroperties)
{
...
ShaderQueueSuit_TexRect::~ShaderQueueSuit_TexRect()
{
