...
void ShaderQueueSuit_NoDepth::create_pipe_line(VkDevice& device,VkRenderPass& renderPass)
{
    ...
    att_state[0].dstColorBlendFactor =
            VK_BLEND_FACTOR_ONE_MINUS_SRC_ALPHA; //设置目标颜色混合因子
    att_state[0].srcAlphaBlendFactor = VK_BLEND_FACTOR_SRC_ALPHA;//设置源Alpha 混合因子
    att_state[0].dstAlphaBlendFactor =
            VK_BLEND_FACTOR_ONE_MINUS_SRC_ALPHA; //设置目标Alpha 混合因子
    ...
    ds.front.writeMask=1; 
    ds.front.compareMask=1; 
