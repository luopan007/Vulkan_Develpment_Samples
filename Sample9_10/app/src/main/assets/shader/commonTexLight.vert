...
void main() {
   vec3 lightPos=vec3(myBufferVals.lightPosition.x,myBufferVals.lightPosition.y*(myConstantVals.lightReverseFactor),myBufferVals.lightPosition.z);
