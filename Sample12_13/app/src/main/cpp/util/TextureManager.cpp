...
#include <assert.h>
std::vector<std::string> TextureManager::texNames={"texture/grass.bntex","texture/rock.bntex"};
std::vector<std::string> TextureManager::doubleNames={"texture/grass.bntex","texture/rock.bntex"};
