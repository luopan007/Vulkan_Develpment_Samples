...
void ShaderQueueSuit_SingleTexLight::create_uniform_buffer(VkDevice& device,VkPhysicalDeviceMemoryProperties& memoryroperties)
{
...
void ShaderQueueSuit_SingleTexLight::destroy_uniform_buffer(VkDevice& device)
{
...
void ShaderQueueSuit_SingleTexLight::create_pipeline_layout(VkDevice& device)
{
...
void ShaderQueueSuit_SingleTexLight::destroy_pipeline_layout(VkDevice& device)
{
...
void ShaderQueueSuit_SingleTexLight::init_descriptor_set(VkDevice& device)
{
...
void ShaderQueueSuit_SingleTexLight::create_shader(VkDevice& device)
{
    std::string vertStr= FileUtil::loadAssetStr("shader/SingleTexLight.vert");
    std::string fragStr= FileUtil::loadAssetStr("shader/SingleTexLight.frag");
...
void ShaderQueueSuit_SingleTexLight::destroy_shader(VkDevice& device)
{
    vk::vkDestroyShaderModule(device, shaderStages[0].module, NULL);
    vk::vkDestroyShaderModule(device, shaderStages[1].module, NULL);
}

void ShaderQueueSuit_SingleTexLight::initVertexAttributeInfo()
{
...
void ShaderQueueSuit_SingleTexLight::create_pipe_line(VkDevice& device,VkRenderPass& renderPass)
{
...
void ShaderQueueSuit_SingleTexLight::destroy_pipe_line(VkDevice& device)
{
...
ShaderQueueSuit_SingleTexLight::ShaderQueueSuit_SingleTexLight(VkDevice* deviceIn,VkRenderPass& renderPass,VkPhysicalDeviceMemoryProperties& memoryroperties)
{
...
ShaderQueueSuit_SingleTexLight::~ShaderQueueSuit_SingleTexLight()
{
