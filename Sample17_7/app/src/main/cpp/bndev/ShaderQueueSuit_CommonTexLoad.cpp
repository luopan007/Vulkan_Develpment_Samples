#include "ShaderQueueSuit_CommonTexLoad.h"
#include <assert.h>
...
void ShaderQueueSuit_CommonTexLoad::create_uniform_buffer(VkDevice& device,VkPhysicalDeviceMemoryProperties& memoryroperties)
{
...
void ShaderQueueSuit_CommonTexLoad::destroy_uniform_buffer(VkDevice& device)
{
    vk::vkDestroyBuffer(device, uniformBuf, NULL);
    vk::vkFreeMemory(device, memUniformBuf, NULL);
}
void ShaderQueueSuit_CommonTexLoad::create_pipeline_layout(VkDevice& device)
{
...
void ShaderQueueSuit_CommonTexLoad::destroy_pipeline_layout(VkDevice& device)
{
...
void ShaderQueueSuit_CommonTexLoad::init_descriptor_set(VkDevice& device)
{
...
void ShaderQueueSuit_CommonTexLoad::create_shader(VkDevice& device)
{
    std::string vertStr= FileUtil::loadAssetStr("shader/commonTexLoad.vert");
    std::string fragStr= FileUtil::loadAssetStr("shader/commonTexLoad.frag");
...
void ShaderQueueSuit_CommonTexLoad::destroy_shader(VkDevice& device)
{
    vk::vkDestroyShaderModule(device, shaderStages[0].module, NULL);
    vk::vkDestroyShaderModule(device, shaderStages[1].module, NULL);
}
void ShaderQueueSuit_CommonTexLoad::initVertexAttributeInfo()
{
...
void ShaderQueueSuit_CommonTexLoad::create_pipe_line(VkDevice& device,VkRenderPass& renderPass)
{
...
void ShaderQueueSuit_CommonTexLoad::destroy_pipe_line(VkDevice& device)
{
    vk::vkDestroyPipeline(device, pipeline, NULL);
    vk::vkDestroyPipelineCache(device, pipelineCache, NULL);
}
ShaderQueueSuit_CommonTexLoad::ShaderQueueSuit_CommonTexLoad(VkDevice* deviceIn,VkRenderPass& renderPass,VkPhysicalDeviceMemoryProperties& memoryroperties)
{
...
ShaderQueueSuit_CommonTexLoad::~ShaderQueueSuit_CommonTexLoad()
{
