...
std::vector<std::string> TextureManager::texNames={"texture/poolnew.bntex","texture/skycubemap_left.bntex","texture/skycubemap_right.bntex","texture/skycubemap_down.bntex","texture/skycubemap_up.bntex","texture/skycubemap_back.bntex","texture/skycubemap_front.bntex","texture/cube.bntexcube"};
std::vector<std::string> TextureManager::texNamesForCubeMap={"texture/cube.bntexcube"};
std::vector<std::string> TextureManager::texNamesForSkyBox={"texture/skycubemap_left.bntex","texture/skycubemap_right.bntex","texture/skycubemap_down.bntex","texture/skycubemap_up.bntex","texture/skycubemap_back.bntex","texture/skycubemap_front.bntex","texture/poolnew.bntex"};
