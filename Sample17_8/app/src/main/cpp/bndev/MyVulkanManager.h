...
public:
    ...
    static ObjObject* objObject1;
    static ObjObject* objObject2;
    static ObjObject* objObject3;
    static float xAngle;
    static float yAngle;

    static void drawTask0(SCBArangeThreadTask* stta);
    static void drawTask1(SCBArangeThreadTask* stta);
    static void drawTask2(SCBArangeThreadTask* stta);
    static void drawTask3(SCBArangeThreadTask* stta);
    static void drawSpec3D(SCBArangeThreadTask* stta, float pyx, float pyy, float pyz,
                                            float scx, float scy, float scz, ObjObject* oo, std::string texName,float* currMatrix, float* MVP);
    static VkCommandBufferBeginInfo secondary_begin;
    static VkCommandBufferInheritanceInfo cmd_buf_inheritance_info;
    static PlanePosition* planePosition0;
    static PlanePosition* planePosition1;
    static PlanePosition* planePosition2;
    static PlanePosition* planePosition3;
    static Semaphore* hSemaphore[4];
