...
class MyVulkanManager
{
  public:
    ...
    static ShaderQueueSuit_DoubleTexLight* sqsDTL;
    static ShaderQueueSuit_Color* sqsC;
    static ShaderQueueSuit_Cloud* sqsCloud;
    static TexLightObject* ballForDraw;
    static TexLightObject* cloudBallForDraw;
