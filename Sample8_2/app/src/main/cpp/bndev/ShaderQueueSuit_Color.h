...
#ifndef SAMPLE5_1_SHADERQUEUESUIT_COLOR_H
#define SAMPLE5_1_SHADERQUEUESUIT_COLOR_H
#include <vector>
...
public:
    ...
    VkPipeline pipeline;
    ShaderQueueSuit_Color(VkDevice* deviceIn,VkRenderPass& renderPass,VkPhysicalDeviceMemoryProperties& memoryroperties);
