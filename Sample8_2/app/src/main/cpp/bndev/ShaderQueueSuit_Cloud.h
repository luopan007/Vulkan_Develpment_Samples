...
#ifndef SAMPLE5_6_SHADERQUEUESUIT_CLOUD_H
#define SAMPLE5_6_SHADERQUEUESUIT_CLOUD_H
#include <vector>
#include <vulkan/vulkan.h>
class ShaderQueueSuit_Cloud
{
private:
    VkBuffer uniformBuf;
...
public:
    ...
    VkPipeline pipeline;
    ShaderQueueSuit_Cloud(VkDevice* deviceIn, VkRenderPass& renderPass, VkPhysicalDeviceMemoryProperties& memoryroperties);
    ~ShaderQueueSuit_Cloud();
};
#endif 
