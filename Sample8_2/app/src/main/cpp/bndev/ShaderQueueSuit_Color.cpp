...
void ShaderQueueSuit_Color::create_uniform_buffer(VkDevice& device,VkPhysicalDeviceMemoryProperties& memoryroperties)
{
...
void ShaderQueueSuit_Color::destroy_uniform_buffer(VkDevice& device)
{
    vk::vkDestroyBuffer(device, uniformBuf, NULL);
    vk::vkFreeMemory(device, memUniformBuf, NULL);
}
void ShaderQueueSuit_Color::create_pipeline_layout(VkDevice& device)
{
...
void ShaderQueueSuit_Color::destroy_pipeline_layout(VkDevice& device)
{
...
void ShaderQueueSuit_Color::init_descriptor_set(VkDevice& device)
{
...
void ShaderQueueSuit_Color::create_shader(VkDevice& device)
{
    std::string vertStr= FileUtil::loadAssetStr("shader/commonColor.vert");
    std::string fragStr= FileUtil::loadAssetStr("shader/commonColor.frag");
...
void ShaderQueueSuit_Color::destroy_shader(VkDevice& device)
{
...
void ShaderQueueSuit_Color::create_pipe_line(VkDevice& device,VkRenderPass& renderPass)
{
...
void ShaderQueueSuit_Color::destroy_pipe_line(VkDevice& device)
{
    vk::vkDestroyPipeline(device, pipeline, NULL);
    vk::vkDestroyPipelineCache(device, pipelineCache, NULL);
}
ShaderQueueSuit_Color::ShaderQueueSuit_Color(VkDevice* deviceIn,VkRenderPass& renderPass,VkPhysicalDeviceMemoryProperties& memoryroperties)
{
