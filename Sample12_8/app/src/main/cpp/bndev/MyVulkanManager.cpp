...
{
    MatrixState3D::setCamera(0,0,5.5f,0,0,0,0,1,0);
...
void MyVulkanManager::flushTexToDesSet() {
    sqsCT->writes[0].dstSet = sqsCT->descSet[0];//更新描述集对应的写入属性
    vk::vkUpdateDescriptorSets(device, 1, sqsCT->writes, 0, NULL);//更新描述集
}
