...
std::vector<std::string> TextureManager::texNames={"texture/dx1.bntex","texture/car.bntex","texture/carBody.bntex","texture/carWheel.bntex","texture/pt.bntex","texture/sn.bntex"};
