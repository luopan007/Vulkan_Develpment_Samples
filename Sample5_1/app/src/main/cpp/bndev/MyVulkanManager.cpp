...
void MyVulkanManager::createDrawableObject(){//创建绘制用物体的方法
    ...
    ballForDraw=new DrawableObjectCommonLight(BallData::vdata, BallData::dataByteCount,BallData::vCount,device,memoryroperties); //创建绘制用球对象
}
...
{
    MatrixState3D::setCamera(0,0,3,0,0,0,0,1,0);
