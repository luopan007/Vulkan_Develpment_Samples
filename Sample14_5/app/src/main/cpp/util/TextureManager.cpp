...
std::vector<std::string> TextureManager::texNames={"texture/ghxp.bntex","texture/c1.bntex","texture/c2.bntex","texture/pm.bntex"};
std::vector<std::string> TextureManager::texNamesForCommonTexLight={"texture/ghxp.bntex","texture/c1.bntex","texture/c2.bntex","texture/pm.bntex"};
