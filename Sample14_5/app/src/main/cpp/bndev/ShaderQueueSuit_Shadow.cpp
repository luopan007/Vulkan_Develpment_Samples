...
void ShaderQueueSuit_Shadow::create_uniform_buffer(VkDevice& device,VkPhysicalDeviceMemoryProperties& memoryroperties)
{
    bufferByteCount=sizeof(float)*32;
...
void ShaderQueueSuit_Shadow::destroy_uniform_buffer(VkDevice& device)
{
    vk::vkDestroyBuffer(device, uniformBuf, NULL);
    vk::vkFreeMemory(device, memUniformBuf, NULL);
}
void ShaderQueueSuit_Shadow::create_pipeline_layout(VkDevice& device)
{
...
void ShaderQueueSuit_Shadow::destroy_pipeline_layout(VkDevice& device)
{
...
void ShaderQueueSuit_Shadow::init_descriptor_set(VkDevice& device)
{
...
void ShaderQueueSuit_Shadow::create_shader(VkDevice& device)
{
    std::string vertStr= FileUtil::loadAssetStr("shader/shadow.vert");
    std::string fragStr= FileUtil::loadAssetStr("shader/shadow.frag");
...
void ShaderQueueSuit_Shadow::create_pipe_line(VkDevice& device,VkRenderPass& renderPass)
{
...
void ShaderQueueSuit_Shadow::destroy_pipe_line(VkDevice& device)
{
    vk::vkDestroyPipeline(device, pipeline, NULL);
    vk::vkDestroyPipelineCache(device, pipelineCache, NULL);
}
ShaderQueueSuit_Shadow::ShaderQueueSuit_Shadow(VkDevice* deviceIn,VkRenderPass& renderPass,VkPhysicalDeviceMemoryProperties& memoryroperties)
{
...
ShaderQueueSuit_Shadow::~ShaderQueueSuit_Shadow()
{
