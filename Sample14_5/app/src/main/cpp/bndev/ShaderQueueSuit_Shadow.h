#ifndef VULKANEXBASE_SHADERQUEUESUIT_COMMONTEX_H
#define VULKANEXBASE_SHADERQUEUESUIT_COMMONTEX_H
#include <vector>
#include <vulkan/vulkan.h>
#include "../vksysutil/vulkan_wrapper.h"
class ShaderQueueSuit_Shadow
{
private:
    VkBuffer uniformBuf;
...
public:
    ...
    VkPipeline pipeline;
    ShaderQueueSuit_Shadow(VkDevice* deviceIn,VkRenderPass& renderPass,VkPhysicalDeviceMemoryProperties& memoryroperties);
    ~ShaderQueueSuit_Shadow();
};
#endif 
