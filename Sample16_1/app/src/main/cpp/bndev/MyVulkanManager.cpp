...
Robot*  MyVulkanManager::robot;
ObjObject* MyVulkanManager::plane;
vector<ObjObject*> MyVulkanManager::robotObj;
...
{
    robotObj.push_back(LoadUtil::loadFromFile("model/body.obj",device,memoryroperties));
    robotObj.push_back(LoadUtil::loadFromFile("model/head.obj",device,memoryroperties));
    robotObj.push_back(LoadUtil::loadFromFile("model/left_top.obj",device,memoryroperties));
    robotObj.push_back(LoadUtil::loadFromFile("model/left_bottom.obj",device,memoryroperties));
    robotObj.push_back(LoadUtil::loadFromFile("model/right_top.obj",device,memoryroperties));
    robotObj.push_back(LoadUtil::loadFromFile("model/right_bottom.obj",device,memoryroperties));
    robotObj.push_back(LoadUtil::loadFromFile("model/right_leg_top.obj",device,memoryroperties));
    robotObj.push_back(LoadUtil::loadFromFile("model/right_leg_bottom.obj",device,memoryroperties));
    robotObj.push_back(LoadUtil::loadFromFile("model/left_leg_top.obj",device,memoryroperties));
    robotObj.push_back(LoadUtil::loadFromFile("model/left_leg_bottom.obj",device,memoryroperties));
    robotObj.push_back(LoadUtil::loadFromFile("model/left_foot.obj",device,memoryroperties));
    robotObj.push_back(LoadUtil::loadFromFile("model/right_foot.obj",device,memoryroperties));
    robot=new Robot(robotObj);
    plane=LoadUtil::loadFromFile("model/floor.obj",device,memoryroperties);
}
void MyVulkanManager::destroyDrawableObject()
{
    delete robot;
    for(ObjObject* object:robotObj)
    {
        delete object;
    }
    delete plane;
...
{
    FPSUtil::init();
    DoAction * doAction=new DoAction(robot);
    while(MyVulkanManager::loopDrawFlag){
        ...
        MatrixState3D::translate(0,-1,0);
        MatrixState3D::pushMatrix();
        MatrixState3D::scale(2,2,2);
        robot->drawSelf(cmdBuffer,sqsCL->pipelineLayout,sqsCL->pipeline,
                        &(sqsCL->descSet[TextureManager::getVkDescriptorSetIndex("texture/arm.bntex")]));
        MatrixState3D::popMatrix();
/*
       MatrixState3D::pushMatrix();
       MatrixState3D::scale(0.5,0.5,0.5);
       plane->drawSelf(cmdBuffer,sqsCL->pipelineLayout,sqsCL->pipeline,
                       &(sqsCL->descSet[TextureManager::getVkDescriptorSetIndex("texture/wenli.bntex")]));
       MatrixState3D::popMatrix();
*/
        MatrixState3D::popMatrix();
