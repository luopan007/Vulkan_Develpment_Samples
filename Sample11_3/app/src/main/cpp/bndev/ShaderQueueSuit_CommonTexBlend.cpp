...
void ShaderQueueSuit_CommonTexBlend::create_uniform_buffer(VkDevice& device,VkPhysicalDeviceMemoryProperties& memoryroperties)
{
    bufferByteCount=3*sizeof(float);
...
void ShaderQueueSuit_CommonTexBlend::destroy_uniform_buffer(VkDevice& device)
{
    vk::vkDestroyBuffer(device, uniformBuf, NULL);
    vk::vkFreeMemory(device, memUniformBuf, NULL);
}
void ShaderQueueSuit_CommonTexBlend::create_pipeline_layout(VkDevice& device)
{
...
void ShaderQueueSuit_CommonTexBlend::destroy_pipeline_layout(VkDevice& device)
{
...
void ShaderQueueSuit_CommonTexBlend::init_descriptor_set(VkDevice& device)
{
...
void ShaderQueueSuit_CommonTexBlend::create_shader(VkDevice& device)
{
...
void ShaderQueueSuit_CommonTexBlend::destroy_shader(VkDevice& device)
{
    vk::vkDestroyShaderModule(device, shaderStages[0].module, NULL);
    vk::vkDestroyShaderModule(device, shaderStages[1].module, NULL);
}
void ShaderQueueSuit_CommonTexBlend::initVertexAttributeInfo()
{
...
void ShaderQueueSuit_CommonTexBlend::create_pipe_line(VkDevice& device,VkRenderPass& renderPass)
{
...
void ShaderQueueSuit_CommonTexBlend::destroy_pipe_line(VkDevice& device)
{
    vk::vkDestroyPipeline(device, pipeline, NULL);
    vk::vkDestroyPipelineCache(device, pipelineCache, NULL);
}
ShaderQueueSuit_CommonTexBlend::ShaderQueueSuit_CommonTexBlend(VkDevice* deviceIn,VkRenderPass& renderPass,VkPhysicalDeviceMemoryProperties& memoryroperties)
{
...
ShaderQueueSuit_CommonTexBlend::~ShaderQueueSuit_CommonTexBlend()
{
