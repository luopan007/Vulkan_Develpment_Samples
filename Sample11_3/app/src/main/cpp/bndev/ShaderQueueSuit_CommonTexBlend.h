#ifndef SAMPLE11_3_SHADERQUEUESUIT_COMMONTEXBLEND_H
#define SAMPLE11_3_SHADERQUEUESUIT_COMMONTEXBLEND_H
#include <vector>
#include <vulkan/vulkan.h>
#include "../vksysutil/vulkan_wrapper.h"
class ShaderQueueSuit_CommonTexBlend {
private:
    VkBuffer uniformBuf;
...
public:
    ...
    VkPipeline pipeline;
    ShaderQueueSuit_CommonTexBlend(VkDevice* deviceIn,VkRenderPass& renderPass,VkPhysicalDeviceMemoryProperties& memoryroperties);
    ~ShaderQueueSuit_CommonTexBlend();
};
#endif //SAMPLE11_3_SHADERQUEUESUIT_COMMONTEXBLEND_H
