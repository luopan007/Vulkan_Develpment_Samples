#ifndef VULKANEXBASE_ShaderQueueSuit_CommonTexTrunk_X_H
#define VULKANEXBASE_ShaderQueueSuit_CommonTexTrunk_X_H
#include <vector>
#include <vulkan/vulkan.h>
#include "../vksysutil/vulkan_wrapper.h"
class ShaderQueueSuit_CommonTexTrunk
{
private:
    VkBuffer uniformBuf;
...
public:
    ...
    VkPipeline pipeline;
    ShaderQueueSuit_CommonTexTrunk(VkDevice* deviceIn,VkRenderPass& renderPass,VkPhysicalDeviceMemoryProperties& memoryroperties);
    ~ShaderQueueSuit_CommonTexTrunk();
};
#endif
