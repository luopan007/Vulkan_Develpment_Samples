...
void ShaderQueueSuit_CommonTexTrunk::create_uniform_buffer(VkDevice& device,VkPhysicalDeviceMemoryProperties& memoryroperties)
{
    bufferByteCount=2*sizeof(float);
...
void ShaderQueueSuit_CommonTexTrunk::destroy_uniform_buffer(VkDevice& device)
{
    vk::vkDestroyBuffer(device, uniformBuf, NULL);
    vk::vkFreeMemory(device, memUniformBuf, NULL);
}
void ShaderQueueSuit_CommonTexTrunk::create_pipeline_layout(VkDevice& device)
{
...
void ShaderQueueSuit_CommonTexTrunk::destroy_pipeline_layout(VkDevice& device)
{
...
void ShaderQueueSuit_CommonTexTrunk::init_descriptor_set(VkDevice& device)
{
    VkDescriptorPoolSize type_count[2];
    type_count[0].type = VK_DESCRIPTOR_TYPE_UNIFORM_BUFFER;
    type_count[0].descriptorCount = TextureManager::orTexNames.size();
    type_count[1].type = VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER;
    type_count[1].descriptorCount = TextureManager::orTexNames.size();

    VkDescriptorPoolCreateInfo descriptor_pool = {};
    descriptor_pool.sType = VK_STRUCTURE_TYPE_DESCRIPTOR_POOL_CREATE_INFO;
    descriptor_pool.pNext = NULL;
    descriptor_pool.maxSets = TextureManager::orTexNames.size();
    ...
    alloc_info[0].descriptorSetCount = TextureManager::orTexNames.size();
    alloc_info[0].pSetLayouts = layouts.data();
    descSet.resize(TextureManager::orTexNames.size());
...
void ShaderQueueSuit_CommonTexTrunk::create_shader(VkDevice& device)
{
    std::string vertStr= FileUtil::loadAssetStr("shader/commonTexTree.vert");
    std::string fragStr= FileUtil::loadAssetStr("shader/commonTexTree.frag");
...
void ShaderQueueSuit_CommonTexTrunk::destroy_shader(VkDevice& device)
{
    vk::vkDestroyShaderModule(device, shaderStages[0].module, NULL);
    vk::vkDestroyShaderModule(device, shaderStages[1].module, NULL);
}
void ShaderQueueSuit_CommonTexTrunk::initVertexAttributeInfo()
{
...
void ShaderQueueSuit_CommonTexTrunk::create_pipe_line(VkDevice& device,VkRenderPass& renderPass)
{
...
void ShaderQueueSuit_CommonTexTrunk::destroy_pipe_line(VkDevice& device)
{
    vk::vkDestroyPipeline(device, pipeline, NULL);
    vk::vkDestroyPipelineCache(device, pipelineCache, NULL);
}
ShaderQueueSuit_CommonTexTrunk::ShaderQueueSuit_CommonTexTrunk(VkDevice* deviceIn,VkRenderPass& renderPass,VkPhysicalDeviceMemoryProperties& memoryroperties)
{
...
ShaderQueueSuit_CommonTexTrunk::~ShaderQueueSuit_CommonTexTrunk()
{
