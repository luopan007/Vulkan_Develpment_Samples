...
float MatrixState3D::mMVPMatrixGL[16];
...
float* MatrixState3D::getGLFinalMatrix()
{
	Matrix::multiplyMM(mMVPMatrixGL, 0, mVMatrix, 0, currMatrix, 0);
	Matrix::multiplyMM(mMVPMatrixGL, 0, mProjMatrix, 0, mMVPMatrixGL, 0);
	return mMVPMatrixGL;
}
