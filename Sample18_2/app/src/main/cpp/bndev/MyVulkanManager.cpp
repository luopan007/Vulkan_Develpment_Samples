...
ObjObject* MyVulkanManager::chObject;
ObjObject* MyVulkanManager::yhObject;
ObjObject* MyVulkanManager::qtObject;
ObjObject* MyVulkanManager::lftObject;
ObjObject* MyVulkanManager::pmObject;
...
{
    chObject=LoadUtil::loadFromFile("model/ch.obj",device,memoryroperties);
    yhObject=LoadUtil::loadFromFile("model/yh.obj",device,memoryroperties);
    qtObject=LoadUtil::loadFromFile("model/qt.obj",device,memoryroperties);
    lftObject=LoadUtil::loadFromFile("model/cft.obj",device,memoryroperties);
    pmObject=LoadUtil::loadFromFile("model/pm.obj",device,memoryroperties);
    objList.push_back(chObject);
    objList.push_back(yhObject);
    objList.push_back(qtObject);
    objList.push_back(lftObject);
}
void MyVulkanManager::destroyDrawableObject()
{
    for (ObjObject* obj : objList)
    {
        delete obj;
    }
    delete pmObject;
...
void MyVulkanManager::drawObject()
{
    ...
    while(MyVulkanManager::loopDrawFlag){
        ...
        pmObject->drawSelf(cmdBuffer, sqsCL->pipelineLayout, sqsCL->pipeline,&(sqsCL->descSet[0]));
        MatrixState3D::popMatrix();
        MatrixState3D::pushMatrix();
        MatrixState3D::translate(-30.0f, 0, 0);
        MatrixState3D::scale(lftObject->size, lftObject->size, lftObject->size);
        lftObject->drawSelf(cmdBuffer, sqsCL->pipelineLayout, sqsCL->pipeline,&(sqsCL->descSet[0]));
        MatrixState3D::popMatrix();
        MatrixState3D::pushMatrix();
        MatrixState3D::translate(30.0f, 0.0f, 0);
        MatrixState3D::scale(qtObject->size, qtObject->size, qtObject->size);
        qtObject->drawSelf(cmdBuffer, sqsCL->pipelineLayout, sqsCL->pipeline,&(sqsCL->descSet[0]));
        MatrixState3D::popMatrix();
        MatrixState3D::pushMatrix();
        MatrixState3D::translate(0, 0, -30.0f);
        MatrixState3D::scale(yhObject->size, yhObject->size, yhObject->size);
        MatrixState3D::rotate(45, 0, 1, 0);
        yhObject->drawSelf(cmdBuffer, sqsCL->pipelineLayout, sqsCL->pipeline,&(sqsCL->descSet[0]));
        MatrixState3D::popMatrix();
        MatrixState3D::pushMatrix();
        MatrixState3D::translate(0, 0, 30.0f);
        MatrixState3D::scale(chObject->size, chObject->size, chObject->size);
        MatrixState3D::rotate(30.0f, 0, 1, 0);
        chObject->drawSelf(cmdBuffer, sqsCL->pipelineLayout, sqsCL->pipeline,&(sqsCL->descSet[0]));
        MatrixState3D::popMatrix();
