...
void ShaderQueueSuit_Common::initVertexAttributeInfo(){ //设置顶点输入属性信息的方法
    ...
    vertexAttribs[0].binding = 0; //第1 个顶点输入属性的绑定点
    vertexAttribs[0].location = 0; //第1 个顶点输入属性的位置索引
    vertexAttribs[0].format = VK_FORMAT_R32G32B32_SFLOAT; //第1 个顶点输入属性的数据格式
    vertexAttribs[0].offset = 0; //第1 个顶点输入属性的偏移量
    vertexAttribs[1].binding = 0; //第2 个顶点输入属性的绑定点
    vertexAttribs[1].location = 1; //第2 个顶点输入属性的位置索引
    vertexAttribs[1].format = VK_FORMAT_R32G32_SFLOAT; //第2 个顶点输入属性的数据格式
    vertexAttribs[1].offset = 12; //第2 个顶点输入属性的偏移量
    vertexAttribs[2].binding = 0; //第3 个顶点输入属性的绑定点
    vertexAttribs[2].location = 2; //第3 个顶点输入属性的位置索引
    vertexAttribs[2].format = VK_FORMAT_R32G32B32_SFLOAT; //第3 个顶点输入属性的数据格式
    vertexAttribs[2].offset = 20; //第3 个顶点输入属性的偏移量
}
